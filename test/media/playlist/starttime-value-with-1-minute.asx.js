var result = [
    "Opening: starttime-value-with-1-minute.asx", 
    "OnMediaOpened (MediaElement [starttime-value-with-1-minute.asx], RoutedEventArgs", 
    ...
    " Source: starttime-value-with-1-minute.asx", 
