...
enum RuntimeInitFlag {
	...
	RUNTIME_INIT_USE_BACKEND_IMAGE     = 1 << 19,
	...
	RUNTIME_INIT_ENABLE_EFFECTS        = 1 << 26,
	RUNTIME_INIT_ENABLE_PROJECTIONS    = 1 << 27,
	RUNTIME_INIT_ENABLE_CACHE_MODE     = 1 << 28,
	RUNTIME_INIT_CURL_BRIDGE	   = 1 << 29,
	RUNTIME_INIT_ENABLE_TOGGLEREFS	   = 1 << 30,
	RUNTIME_INIT_OOB_LAUNCHER_FIREFOX  = 1 << 31,
};
