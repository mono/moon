...
const int FrameworkElement::WidthProperty = 170;
const int FrameworkElement::VerticalAlignmentProperty = 171;
const int FrameworkElement::StyleProperty = 172;
const int FrameworkElement::MinWidthProperty = 173;
const int FrameworkElement::MinHeightProperty = 174;
const int FrameworkElement::MaxWidthProperty = 175;
const int FrameworkElement::MaxHeightProperty = 176;
const int FrameworkElement::MarginProperty = 177;
const int FrameworkElement::LanguageProperty = 178;
const int FrameworkElement::HorizontalAlignmentProperty = 179;
const int FrameworkElement::HeightProperty = 180;
const int FrameworkElement::DataContextProperty = 181;
const int FrameworkElement::ActualWidthProperty = 182;
const int FrameworkElement::ActualHeightProperty = 183;
const int PowerEase::PowerProperty = 184;
const int ExponentialEase::ExponentProperty = 185;
const int ElasticEase::SpringinessProperty = 186;
const int ElasticEase::OscillationsProperty = 187;
const int BounceEase::BouncinessProperty = 188;
const int BounceEase::BouncesProperty = 189;
const int BackEase::AmplitudeProperty = 190;
const int SplinePointKeyFrame::KeySplineProperty = 191;
const int EasingPointKeyFrame::EasingFunctionProperty = 192;
const int PointAnimationUsingKeyFrames::KeyFramesProperty = 193;
const int SplineDoubleKeyFrame::KeySplineProperty = 194;
const int EasingDoubleKeyFrame::EasingFunctionProperty = 195;
const int DoubleAnimationUsingKeyFrames::KeyFramesProperty = 196;
const int TimelineMarker::TypeProperty = 197;
const int TimelineMarker::TimeProperty = 198;
const int TimelineMarker::TextProperty = 199;
const int Timeline::SpeedRatioProperty = 200;
const int Timeline::RepeatBehaviorProperty = 201;
const int Timeline::FillBehaviorProperty = 202;
const int Timeline::DurationProperty = 203;
const int Timeline::BeginTimeProperty = 204;
const int Timeline::AutoReverseProperty = 205;
const int StylusPoint::YProperty = 206;
const int StylusPoint::XProperty = 207;
const int StylusPoint::PressureFactorProperty = 208;
const int StylusInfo::IsInvertedProperty = 209;
const int StylusInfo::DeviceTypeProperty = 210;
const int Style::TargetTypeProperty = 211;
const int Style::SettersProperty = 212;
const int Style::IsSealedProperty = 213;
const int Stroke::StylusPointsProperty = 214;
const int Stroke::DrawingAttributesProperty = 215;
const int SetterBase::IsSealedProperty = 216;
const int RowDefinition::MinHeightProperty = 217;
const int RowDefinition::MaxHeightProperty = 218;
const int RowDefinition::HeightProperty = 219;
const int RowDefinition::ActualHeightProperty = 220;
...
const int OutOfBrowserSettings::EnableGPUAccelerationProperty = 225;
const int OutOfBrowserSettings::BlurbProperty = 226;
const int NameScope::NameScopeProperty = 227;
const int MultiScaleSubImage::ZIndexProperty = 228;
const int MultiScaleSubImage::ViewportWidthProperty = 229;
const int MultiScaleSubImage::ViewportOriginProperty = 230;
const int MultiScaleSubImage::OpacityProperty = 231;
const int MultiScaleSubImage::AspectRatioProperty = 232;
const int MediaAttribute::ValueProperty = 233;
const int Matrix::OffsetYProperty = 234;
const int Matrix::OffsetXProperty = 235;
const int Matrix::M22Property = 236;
const int Matrix::M21Property = 237;
const int Matrix::M12Property = 238;
const int Matrix::M11Property = 239;
const int KeySpline::ControlPoint2Property = 240;
const int KeySpline::ControlPoint1Property = 241;
const int InputMethod::IsInputMethodEnabledProperty = 242;
const int Inline::TextDecorationsProperty = 243;
const int Inline::LanguageProperty = 244;
const int Inline::ForegroundProperty = 245;
const int Inline::FontWeightProperty = 246;
const int Inline::FontStyleProperty = 247;
const int Inline::FontStretchProperty = 248;
const int Inline::FontSourceProperty = 249;
const int Inline::FontSizeProperty = 250;
const int Inline::FontFamilyProperty = 251;
const int GradientStop::OffsetProperty = 252;
const int GradientStop::ColorProperty = 253;
const int ExtensionPart::SourceProperty = 254;
const int Geometry::TransformProperty = 255;
const int DrawingAttributes::WidthProperty = 256;
const int DrawingAttributes::OutlineColorProperty = 257;
const int DrawingAttributes::HeightProperty = 258;
const int DrawingAttributes::ColorProperty = 259;
const int Downloader::UriProperty = 260;
const int Downloader::StatusTextProperty = 261;
const int Downloader::StatusProperty = 262;
const int Downloader::ResponseTextProperty = 263;
const int Downloader::DownloadProgressProperty = 264;
const int Deployment::SurfaceProperty = 265;
const int Deployment::RuntimeVersionProperty = 266;
const int Deployment::PartsProperty = 267;
const int Deployment::ExternalPartsProperty = 268;
const int Deployment::ExternalCallersFromCrossDomainProperty = 269;
const int Deployment::EntryPointTypeProperty = 270;
const int Deployment::EntryPointAssemblyProperty = 271;
const int MultiScaleTileSource::TileWidthProperty = 272;
const int MultiScaleTileSource::TileOverlapProperty = 273;
const int MultiScaleTileSource::TileHeightProperty = 274;
const int MultiScaleTileSource::TileBlendTimeProperty = 275;
const int MultiScaleTileSource::ImageWidthProperty = 276;
const int MultiScaleTileSource::ImageHeightProperty = 277;
const int ColumnDefinition::WidthProperty = 278;
const int ColumnDefinition::MinWidthProperty = 279;
const int ColumnDefinition::MaxWidthProperty = 280;
const int ColumnDefinition::ActualWidthProperty = 281;
const int Collection::CountProperty = 282;
const int UIElement::VisibilityProperty = 283;
const int UIElement::UseLayoutRoundingProperty = 284;
const int UIElement::TriggersProperty = 285;
const int UIElement::TagProperty = 286;
const int UIElement::ResourcesProperty = 287;
const int UIElement::RenderTransformProperty = 288;
const int UIElement::RenderTransformOriginProperty = 289;
const int UIElement::OpacityProperty = 290;
const int UIElement::OpacityMaskProperty = 291;
const int UIElement::IsHitTestVisibleProperty = 292;
const int UIElement::CursorProperty = 293;
const int UIElement::ClipProperty = 294;
const int EasingFunctionBase::EasingModeProperty = 295;
const int AssemblyPart::SourceProperty = 296;
const int Application::ResourcesProperty = 297;
const int Accessibility::TitleProperty = 298;
const int Accessibility::DescriptionProperty = 299;
const int Accessibility::ActionDescriptionProperty = 300;
const int SplineColorKeyFrame::KeySplineProperty = 301;
const int EasingColorKeyFrame::EasingFunctionProperty = 302;
const int ColorAnimationUsingKeyFrames::KeyFramesProperty = 303;
const int BitmapImage::UriSourceProperty = 304;
const int BitmapImage::ProgressProperty = 305;
const int TranslateTransform::YProperty = 306;
const int TranslateTransform::XProperty = 307;
const int TransformGroup::ChildrenProperty = 308;
const int TextBox::VerticalScrollBarVisibilityProperty = 309;
const int TextBox::TextWrappingProperty = 310;
const int TextBox::TextProperty = 311;
const int TextBox::TextAlignmentProperty = 312;
const int TextBox::SelectionStartProperty = 313;
const int TextBox::SelectionLengthProperty = 314;
const int TextBox::SelectionForegroundProperty = 315;
const int TextBox::SelectionBackgroundProperty = 316;
const int TextBox::SelectedTextProperty = 317;
const int TextBox::MaxLengthProperty = 318;
const int TextBox::IsReadOnlyProperty = 319;
const int TextBox::HorizontalScrollBarVisibilityProperty = 320;
const int TextBox::FontSourceProperty = 321;
const int TextBox::CaretBrushProperty = 322;
const int TextBox::AcceptsReturnProperty = 323;
const int Storyboard::TargetPropertyProperty = 324;
const int Storyboard::TargetNameProperty = 325;
const int SkewTransform::CenterYProperty = 326;
const int SkewTransform::CenterXProperty = 327;
const int SkewTransform::AngleYProperty = 328;
const int SkewTransform::AngleXProperty = 329;
const int SetterBaseCollection::IsSealedProperty = 330;
const int ScaleTransform::ScaleYProperty = 331;
const int ScaleTransform::ScaleXProperty = 332;
const int ScaleTransform::CenterYProperty = 333;
const int ScaleTransform::CenterXProperty = 334;
const int RotateTransform::CenterYProperty = 335;
const int RotateTransform::CenterXProperty = 336;
const int RotateTransform::AngleProperty = 337;
const int QuadraticBezierSegment::Point2Property = 338;
const int QuadraticBezierSegment::Point1Property = 339;
const int PolyQuadraticBezierSegment::PointsProperty = 340;
const int PolyLineSegment::PointsProperty = 341;
const int PolyBezierSegment::PointsProperty = 342;
const int PointKeyFrame::ValueProperty = 343;
const int PointKeyFrame::KeyTimeProperty = 344;
const int PointAnimation::ToProperty = 345;
const int PointAnimation::FromProperty = 346;
const int PointAnimation::EasingFunctionProperty = 347;
const int PointAnimation::ByProperty = 348;
const int PasswordBox::SelectionStartProperty = 349;
const int PasswordBox::SelectionLengthProperty = 350;
const int PasswordBox::SelectionForegroundProperty = 351;
const int PasswordBox::SelectionBackgroundProperty = 352;
const int PasswordBox::SelectedTextProperty = 353;
const int PasswordBox::PasswordProperty = 354;
const int PasswordBox::PasswordCharProperty = 355;
const int PasswordBox::MaxLengthProperty = 356;
const int PasswordBox::FontSourceProperty = 357;
const int PasswordBox::CaretBrushProperty = 358;
const int ObjectKeyFrame::ValueProperty = 359;
const int ObjectKeyFrame::KeyTimeProperty = 360;
const int ObjectKeyFrame::ConvertedValueProperty = 361;
const int ObjectAnimationUsingKeyFrames::KeyFramesProperty = 362;
const int MatrixTransform::MatrixProperty = 363;
const int LineSegment::PointProperty = 364;
const int LayoutInformation::VisualOffsetProperty = 365;
const int LayoutInformation::PreviousConstraintProperty = 366;
const int LayoutInformation::LayoutSlotProperty = 367;
const int LayoutInformation::LayoutClipProperty = 368;
const int LayoutInformation::LastRenderSizeProperty = 369;
const int LayoutInformation::FinalRectProperty = 370;
const int EventTrigger::RoutedEventProperty = 371;
const int EventTrigger::ActionsProperty = 372;
const int DoubleKeyFrame::ValueProperty = 373;
const int DoubleKeyFrame::KeyTimeProperty = 374;
const int DoubleAnimation::ToProperty = 375;
const int DoubleAnimation::FromProperty = 376;
const int DoubleAnimation::EasingFunctionProperty = 377;
const int DoubleAnimation::ByProperty = 378;
const int DependencyObject::NameProperty = 379;
const int ControlTemplate::TargetTypeProperty = 380;
const int ColorKeyFrame::ValueProperty = 381;
const int ColorKeyFrame::KeyTimeProperty = 382;
const int ColorAnimation::ToProperty = 383;
const int ColorAnimation::FromProperty = 384;
const int ColorAnimation::EasingFunctionProperty = 385;
const int ColorAnimation::ByProperty = 386;
const int BitmapSource::PixelWidthProperty = 387;
const int BitmapSource::PixelHeightProperty = 388;
const int BitmapSource::PixelFormatProperty = 389;
const int BezierSegment::Point3Property = 390;
const int BezierSegment::Point2Property = 391;
const int BezierSegment::Point1Property = 392;
const int BeginStoryboard::StoryboardProperty = 393;
const int ArcSegment::SweepDirectionProperty = 394;
const int ArcSegment::SizeProperty = 395;
const int ArcSegment::RotationAngleProperty = 396;
const int ArcSegment::PointProperty = 397;
const int ArcSegment::IsLargeArcProperty = 398;
