...
Types::RegisterNativeProperties ()
{
	...
	DependencyProperty::Register (this, Type::BITMAPIMAGE, "UriSource", false, new Value (Uri()), Type::URI);
...
const int Control::IsEnabledProperty = 129;
const int Control::HorizontalContentAlignmentProperty = 130;
const int Control::ForegroundProperty = 131;
const int Control::FontWeightProperty = 132;
const int Control::FontStyleProperty = 133;
const int Control::FontStretchProperty = 134;
const int Control::FontSizeProperty = 135;
const int Control::FontFamilyProperty = 136;
const int Control::DefaultStyleKeyProperty = 137;
const int Control::BorderThicknessProperty = 138;
const int Control::BorderBrushProperty = 139;
const int Control::BackgroundProperty = 140;
const int Panel::ChildrenProperty = 141;
const int Panel::BackgroundProperty = 142;
const int Border::PaddingProperty = 143;
const int Border::CornerRadiusProperty = 144;
const int Border::ChildProperty = 145;
const int Border::BorderThicknessProperty = 146;
const int Border::BorderBrushProperty = 147;
const int Border::BackgroundProperty = 148;
const int TimelineGroup::ChildrenProperty = 149;
const int Setter::ValueProperty = 150;
const int Setter::PropertyProperty = 151;
const int Setter::ConvertedValueProperty = 152;
const int Run::TextProperty = 153;
const int RectangleGeometry::RectProperty = 154;
const int RectangleGeometry::RadiusYProperty = 155;
const int RectangleGeometry::RadiusXProperty = 156;
const int PathGeometry::FillRuleProperty = 157;
const int PathGeometry::FiguresProperty = 158;
const int LineGeometry::StartPointProperty = 159;
const int LineGeometry::EndPointProperty = 160;
const int GeometryGroup::FillRuleProperty = 161;
const int GeometryGroup::ChildrenProperty = 162;
const int EllipseGeometry::RadiusYProperty = 163;
const int EllipseGeometry::RadiusXProperty = 164;
const int EllipseGeometry::CenterProperty = 165;
const int FrameworkElement::WidthProperty = 166;
const int FrameworkElement::VerticalAlignmentProperty = 167;
const int FrameworkElement::StyleProperty = 168;
const int FrameworkElement::MinWidthProperty = 169;
const int FrameworkElement::MinHeightProperty = 170;
const int FrameworkElement::MaxWidthProperty = 171;
const int FrameworkElement::MaxHeightProperty = 172;
const int FrameworkElement::MarginProperty = 173;
const int FrameworkElement::LanguageProperty = 174;
const int FrameworkElement::HorizontalAlignmentProperty = 175;
const int FrameworkElement::HeightProperty = 176;
const int FrameworkElement::DataContextProperty = 177;
const int FrameworkElement::ActualWidthProperty = 178;
const int FrameworkElement::ActualHeightProperty = 179;
const int PowerEase::PowerProperty = 180;
const int ExponentialEase::ExponentProperty = 181;
const int ElasticEase::SpringinessProperty = 182;
const int ElasticEase::OscillationsProperty = 183;
const int BounceEase::BouncinessProperty = 184;
const int BounceEase::BouncesProperty = 185;
const int BackEase::AmplitudeProperty = 186;
const int SplinePointKeyFrame::KeySplineProperty = 187;
const int EasingPointKeyFrame::EasingFunctionProperty = 188;
const int PointAnimationUsingKeyFrames::KeyFramesProperty = 189;
const int SplineDoubleKeyFrame::KeySplineProperty = 190;
const int EasingDoubleKeyFrame::EasingFunctionProperty = 191;
...
const int RowDefinition::ActualHeightProperty = 216;
...
const int ColumnDefinition::ActualWidthProperty = 267;
const int Collection::CountProperty = 268;
const int UIElement::VisibilityProperty = 269;
const int UIElement::UseLayoutRoundingProperty = 270;
const int UIElement::TriggersProperty = 271;
const int UIElement::TagProperty = 272;
const int UIElement::ResourcesProperty = 273;
const int UIElement::RenderTransformProperty = 274;
const int UIElement::RenderTransformOriginProperty = 275;
const int UIElement::OpacityProperty = 276;
const int UIElement::OpacityMaskProperty = 277;
const int UIElement::IsHitTestVisibleProperty = 278;
const int UIElement::CursorProperty = 279;
const int UIElement::ClipProperty = 280;
const int EasingFunctionBase::EasingModeProperty = 281;
const int AssemblyPart::SourceProperty = 282;
const int Application::ResourcesProperty = 283;
const int Accessibility::TitleProperty = 284;
const int Accessibility::DescriptionProperty = 285;
const int Accessibility::ActionDescriptionProperty = 286;
const int SplineColorKeyFrame::KeySplineProperty = 287;
const int EasingColorKeyFrame::EasingFunctionProperty = 288;
const int ColorAnimationUsingKeyFrames::KeyFramesProperty = 289;
const int BitmapImage::UriSourceProperty = 290;
const int BitmapImage::ProgressProperty = 291;
const int TranslateTransform::YProperty = 292;
const int TranslateTransform::XProperty = 293;
const int TransformGroup::ChildrenProperty = 294;
const int TextBox::VerticalScrollBarVisibilityProperty = 295;
const int TextBox::TextWrappingProperty = 296;
const int TextBox::TextProperty = 297;
const int TextBox::TextAlignmentProperty = 298;
const int TextBox::SelectionStartProperty = 299;
const int TextBox::SelectionLengthProperty = 300;
const int TextBox::SelectionForegroundProperty = 301;
const int TextBox::SelectionBackgroundProperty = 302;
const int TextBox::SelectedTextProperty = 303;
const int TextBox::MaxLengthProperty = 304;
const int TextBox::IsReadOnlyProperty = 305;
const int TextBox::HorizontalScrollBarVisibilityProperty = 306;
const int TextBox::FontSourceProperty = 307;
const int TextBox::AcceptsReturnProperty = 308;
const int Storyboard::TargetPropertyProperty = 309;
const int Storyboard::TargetNameProperty = 310;
const int SkewTransform::CenterYProperty = 311;
const int SkewTransform::CenterXProperty = 312;
const int SkewTransform::AngleYProperty = 313;
const int SkewTransform::AngleXProperty = 314;
const int SetterBaseCollection::IsSealedProperty = 315;
const int ScaleTransform::ScaleYProperty = 316;
const int ScaleTransform::ScaleXProperty = 317;
const int ScaleTransform::CenterYProperty = 318;
const int ScaleTransform::CenterXProperty = 319;
const int RotateTransform::CenterYProperty = 320;
const int RotateTransform::CenterXProperty = 321;
const int RotateTransform::AngleProperty = 322;
const int QuadraticBezierSegment::Point2Property = 323;
const int QuadraticBezierSegment::Point1Property = 324;
const int PolyQuadraticBezierSegment::PointsProperty = 325;
const int PolyLineSegment::PointsProperty = 326;
const int PolyBezierSegment::PointsProperty = 327;
const int PointKeyFrame::ValueProperty = 328;
const int PointKeyFrame::KeyTimeProperty = 329;
const int PointAnimation::ToProperty = 330;
const int PointAnimation::FromProperty = 331;
const int PointAnimation::EasingFunctionProperty = 332;
const int PointAnimation::ByProperty = 333;
const int PasswordBox::SelectionStartProperty = 334;
const int PasswordBox::SelectionLengthProperty = 335;
const int PasswordBox::SelectionForegroundProperty = 336;
const int PasswordBox::SelectionBackgroundProperty = 337;
const int PasswordBox::SelectedTextProperty = 338;
const int PasswordBox::PasswordProperty = 339;
const int PasswordBox::PasswordCharProperty = 340;
const int PasswordBox::MaxLengthProperty = 341;
const int PasswordBox::FontSourceProperty = 342;
const int ObjectKeyFrame::ValueProperty = 343;
const int ObjectKeyFrame::KeyTimeProperty = 344;
const int ObjectKeyFrame::ConvertedValueProperty = 345;
const int ObjectAnimationUsingKeyFrames::KeyFramesProperty = 346;
const int MatrixTransform::MatrixProperty = 347;
const int LineSegment::PointProperty = 348;
const int LayoutInformation::LayoutSlotProperty = 349;
const int LayoutInformation::LayoutClipProperty = 350;
const int LayoutInformation::LastRenderSizeProperty = 351;
const int LayoutInformation::LastMeasureProperty = 352;
const int LayoutInformation::LastArrangeProperty = 353;
const int EventTrigger::RoutedEventProperty = 354;
const int EventTrigger::ActionsProperty = 355;
const int DoubleKeyFrame::ValueProperty = 356;
const int DoubleKeyFrame::KeyTimeProperty = 357;
const int DoubleAnimation::ToProperty = 358;
const int DoubleAnimation::FromProperty = 359;
const int DoubleAnimation::EasingFunctionProperty = 360;
const int DoubleAnimation::ByProperty = 361;
const int DependencyObject::NameProperty = 362;
const int DeepZoomImageTileSource::UriSourceProperty = 363;
const int ControlTemplate::TargetTypeProperty = 364;
const int ColorKeyFrame::ValueProperty = 365;
const int ColorKeyFrame::KeyTimeProperty = 366;
const int ColorAnimation::ToProperty = 367;
const int ColorAnimation::FromProperty = 368;
const int ColorAnimation::EasingFunctionProperty = 369;
const int ColorAnimation::ByProperty = 370;
const int BitmapSource::PixelWidthProperty = 371;
const int BitmapSource::PixelHeightProperty = 372;
const int BitmapSource::PixelFormatProperty = 373;
const int BezierSegment::Point3Property = 374;
const int BezierSegment::Point2Property = 375;
const int BezierSegment::Point1Property = 376;
const int BeginStoryboard::StoryboardProperty = 377;
const int ArcSegment::SweepDirectionProperty = 378;
const int ArcSegment::SizeProperty = 379;
const int ArcSegment::RotationAngleProperty = 380;
const int ArcSegment::PointProperty = 381;
const int ArcSegment::IsLargeArcProperty = 382;
