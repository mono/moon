...
const int InkPresenter::StrokesProperty = 2;
const int VisualBrush::VisualProperty = 3;
const int VideoBrush::SourceNameProperty = 4;
const int ImageBrush::ImageSourceProperty = 5;
const int ImageBrush::DownloadProgressProperty = 6;
const int RadialGradientBrush::RadiusYProperty = 7;
const int RadialGradientBrush::RadiusXProperty = 8;
const int RadialGradientBrush::GradientOriginProperty = 9;
const int RadialGradientBrush::CenterProperty = 10;
const int LinearGradientBrush::StartPointProperty = 11;
const int LinearGradientBrush::EndPointProperty = 12;
const int Rectangle::RadiusYProperty = 13;
const int Rectangle::RadiusXProperty = 14;
const int Polyline::PointsProperty = 15;
const int Polyline::FillRuleProperty = 16;
const int Polygon::PointsProperty = 17;
const int Polygon::FillRuleProperty = 18;
const int Path::DataProperty = 19;
const int Line::Y2Property = 20;
const int Line::Y1Property = 21;
const int Line::X2Property = 22;
const int Line::X1Property = 23;
const int MultiScaleImage::ViewportWidthProperty = 24;
const int MultiScaleImage::ViewportOriginProperty = 25;
const int MultiScaleImage::UseSpringsProperty = 26;
