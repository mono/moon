...
Types::RegisterNativeProperties ()
{
	...
	DependencyProperty::RegisterFull (this, Type::CONTROL, "TemplateOwner", true, NULL, Type::DEPENDENCY_OBJECT, true, false, false, NULL, NULL, NULL, false);
...
const int Control::TemplateOwnerProperty = 127;
const int Control::TabNavigationProperty = 128;
const int Control::TabIndexProperty = 129;
const int Control::PaddingProperty = 130;
const int Control::IsTemplateItemProperty = 131;
const int Control::IsTabStopProperty = 132;
const int Control::IsEnabledProperty = 133;
...
const int TimelineMarker::TypeProperty = 202;
const int TimelineMarker::TimeProperty = 203;
const int TimelineMarker::TextProperty = 204;
const int Timeline::SpeedRatioProperty = 205;
const int Timeline::RepeatBehaviorProperty = 206;
const int Timeline::FillBehaviorProperty = 207;
const int Timeline::DurationProperty = 208;
const int Timeline::BeginTimeProperty = 209;
const int Timeline::AutoReverseProperty = 210;
const int StylusPoint::YProperty = 211;
const int StylusPoint::XProperty = 212;
const int StylusPoint::PressureFactorProperty = 213;
const int StylusInfo::IsInvertedProperty = 214;
const int StylusInfo::DeviceTypeProperty = 215;
const int Style::TargetTypeProperty = 216;
const int Style::SettersProperty = 217;
const int Style::IsSealedProperty = 218;
const int Stroke::StylusPointsProperty = 219;
const int Stroke::DrawingAttributesProperty = 220;
const int SetterBase::IsSealedProperty = 221;
const int RowDefinition::MinHeightProperty = 222;
const int RowDefinition::MaxHeightProperty = 223;
const int RowDefinition::HeightProperty = 224;
const int RowDefinition::ActualHeightProperty = 225;
...
const int SetterBaseCollection::IsSealedProperty = 343;
const int ScaleTransform::ScaleYProperty = 344;
const int ScaleTransform::ScaleXProperty = 345;
const int ScaleTransform::CenterYProperty = 346;
const int ScaleTransform::CenterXProperty = 347;
const int RotateTransform::CenterYProperty = 348;
const int RotateTransform::CenterXProperty = 349;
const int RotateTransform::AngleProperty = 350;
const int QuadraticBezierSegment::Point2Property = 351;
const int QuadraticBezierSegment::Point1Property = 352;
const int PolyQuadraticBezierSegment::PointsProperty = 353;
const int PolyLineSegment::PointsProperty = 354;
const int PolyBezierSegment::PointsProperty = 355;
const int PointKeyFrame::ValueProperty = 356;
const int PointKeyFrame::KeyTimeProperty = 357;
const int PointAnimation::ToProperty = 358;
const int PointAnimation::FromProperty = 359;
const int PointAnimation::EasingFunctionProperty = 360;
const int PointAnimation::ByProperty = 361;
const int PasswordBox::SelectionStartProperty = 362;
const int PasswordBox::SelectionLengthProperty = 363;
const int PasswordBox::SelectionForegroundProperty = 364;
const int PasswordBox::SelectionBackgroundProperty = 365;
const int PasswordBox::SelectedTextProperty = 366;
const int PasswordBox::PasswordProperty = 367;
const int PasswordBox::PasswordCharProperty = 368;
const int PasswordBox::MaxLengthProperty = 369;
const int PasswordBox::FontSourceProperty = 370;
const int PasswordBox::CaretBrushProperty = 371;
const int ObjectKeyFrame::ValueProperty = 372;
const int ObjectKeyFrame::KeyTimeProperty = 373;
const int ObjectKeyFrame::ConvertedValueProperty = 374;
const int ObjectAnimationUsingKeyFrames::KeyFramesProperty = 375;
const int MatrixTransform::MatrixProperty = 376;
const int LineSegment::PointProperty = 377;
const int LayoutInformation::VisualOffsetProperty = 378;
const int LayoutInformation::PreviousConstraintProperty = 379;
const int LayoutInformation::LayoutSlotProperty = 380;
const int LayoutInformation::LayoutClipProperty = 381;
const int LayoutInformation::LastRenderSizeProperty = 382;
const int LayoutInformation::FinalRectProperty = 383;
const int ExtensionPart::SourceProperty = 384;
const int EventTrigger::RoutedEventProperty = 385;
const int EventTrigger::ActionsProperty = 386;
const int DropShadowEffect::ShadowDepthProperty = 387;
const int DropShadowEffect::OpacityProperty = 388;
const int DropShadowEffect::DirectionProperty = 389;
const int DropShadowEffect::ColorProperty = 390;
const int DropShadowEffect::BlurRadiusProperty = 391;
const int DoubleKeyFrame::ValueProperty = 392;
const int DoubleKeyFrame::KeyTimeProperty = 393;
const int DoubleAnimation::ToProperty = 394;
const int DoubleAnimation::FromProperty = 395;
const int DoubleAnimation::EasingFunctionProperty = 396;
const int DoubleAnimation::ByProperty = 397;
const int DependencyObject::NameProperty = 398;
const int ControlTemplate::TargetTypeProperty = 399;
const int ColorKeyFrame::ValueProperty = 400;
const int ColorKeyFrame::KeyTimeProperty = 401;
const int ColorAnimation::ToProperty = 402;
const int ColorAnimation::FromProperty = 403;
const int ColorAnimation::EasingFunctionProperty = 404;
const int ColorAnimation::ByProperty = 405;
const int BlurEffect::RadiusProperty = 406;
const int BitmapSource::PixelWidthProperty = 407;
const int BitmapSource::PixelHeightProperty = 408;
const int BitmapSource::PixelFormatProperty = 409;
const int BitmapCache::RenderAtScaleProperty = 410;
const int BezierSegment::Point3Property = 411;
const int BezierSegment::Point2Property = 412;
const int BezierSegment::Point1Property = 413;
const int BeginStoryboard::StoryboardProperty = 414;
const int ArcSegment::SweepDirectionProperty = 415;
const int ArcSegment::SizeProperty = 416;
const int ArcSegment::RotationAngleProperty = 417;
const int ArcSegment::PointProperty = 418;
const int ArcSegment::IsLargeArcProperty = 419;
...
DependencyObject *
Control::GetTemplateOwner (DependencyObject *obj)
{
	Value *value = (!obj) ? NULL : obj->GetValue (Control::TemplateOwnerProperty);
	if (!value) value = Deployment::GetCurrent ()->GetTypes ()->GetProperty (Control::TemplateOwnerProperty)->GetDefaultValue();
	return value ? value->AsDependencyObject () : NULL;
}

void
Control::SetTemplateOwner (DependencyObject *obj, DependencyObject *value)
{
	if (!obj) return;
	obj->SetValue (Control::TemplateOwnerProperty, Value::CreateUnrefPtr (value));
}
