...
const int EasingColorKeyFrame::EasingFunctionProperty = 285;
const int ColorAnimationUsingKeyFrames::KeyFramesProperty = 286;
const int BitmapImage::UriSourceProperty = 287;
const int BitmapImage::ProgressProperty = 288;
const int TranslateTransform::YProperty = 289;
const int TranslateTransform::XProperty = 290;
const int TransformGroup::ChildrenProperty = 291;
const int TextBox::VerticalScrollBarVisibilityProperty = 292;
const int TextBox::TextWrappingProperty = 293;
const int TextBox::TextProperty = 294;
const int TextBox::TextAlignmentProperty = 295;
const int TextBox::SelectionStartProperty = 296;
const int TextBox::SelectionLengthProperty = 297;
const int TextBox::SelectionForegroundProperty = 298;
const int TextBox::SelectionBackgroundProperty = 299;
const int TextBox::SelectedTextProperty = 300;
const int TextBox::MaxLengthProperty = 301;
const int TextBox::IsReadOnlyProperty = 302;
const int TextBox::HorizontalScrollBarVisibilityProperty = 303;
const int TextBox::FontSourceProperty = 304;
const int TextBox::AcceptsReturnProperty = 305;
const int Storyboard::TargetPropertyProperty = 306;
const int Storyboard::TargetNameProperty = 307;
const int SkewTransform::CenterYProperty = 308;
const int SkewTransform::CenterXProperty = 309;
const int SkewTransform::AngleYProperty = 310;
const int SkewTransform::AngleXProperty = 311;
const int SetterBaseCollection::IsSealedProperty = 312;
const int ScaleTransform::ScaleYProperty = 313;
const int ScaleTransform::ScaleXProperty = 314;
const int ScaleTransform::CenterYProperty = 315;
const int ScaleTransform::CenterXProperty = 316;
const int RotateTransform::CenterYProperty = 317;
const int RotateTransform::CenterXProperty = 318;
const int RotateTransform::AngleProperty = 319;
const int QuadraticBezierSegment::Point2Property = 320;
const int QuadraticBezierSegment::Point1Property = 321;
const int PolyQuadraticBezierSegment::PointsProperty = 322;
const int PolyLineSegment::PointsProperty = 323;
const int PolyBezierSegment::PointsProperty = 324;
const int PointKeyFrame::ValueProperty = 325;
const int PointKeyFrame::KeyTimeProperty = 326;
const int PointAnimation::ToProperty = 327;
const int PointAnimation::FromProperty = 328;
const int PointAnimation::EasingFunctionProperty = 329;
const int PointAnimation::ByProperty = 330;
const int PasswordBox::SelectionStartProperty = 331;
const int PasswordBox::SelectionLengthProperty = 332;
const int PasswordBox::SelectionForegroundProperty = 333;
const int PasswordBox::SelectionBackgroundProperty = 334;
const int PasswordBox::SelectedTextProperty = 335;
const int PasswordBox::PasswordProperty = 336;
const int PasswordBox::PasswordCharProperty = 337;
const int PasswordBox::MaxLengthProperty = 338;
const int PasswordBox::FontSourceProperty = 339;
const int ObjectKeyFrame::ValueProperty = 340;
const int ObjectKeyFrame::KeyTimeProperty = 341;
const int ObjectKeyFrame::ConvertedValueProperty = 342;
