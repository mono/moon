...
{
	Application::ResourcesProperty = DependencyProperty::Register (this, Type::APPLICATION, "Resources", Type::RESOURCE_DICTIONARY);
	...
	Border::BorderThicknessProperty = DependencyProperty::RegisterFull (this, Type::BORDER, "BorderThickness", new Value (Thickness(0)), Type::THICKNESS, false, false, false, NULL, Validators::BorderThicknessValidator, false, false);
	Border::ChildProperty = DependencyProperty::Register (this, Type::BORDER, "Child", Type::UIELEMENT);
	Border::CornerRadiusProperty = DependencyProperty::RegisterFull (this, Type::BORDER, "CornerRadius", NULL, Type::CORNERRADIUS, false, false, false, NULL, Validators::CornerRadiusValidator, false, false);
	Border::PaddingProperty = DependencyProperty::RegisterFull (this, Type::BORDER, "Padding", new Value (Thickness(0)), Type::THICKNESS, false, false, false, NULL, Validators::BorderThicknessValidator, false, false);
	...
	Canvas::LeftProperty = DependencyProperty::RegisterFull (this, Type::CANVAS, "Left", new Value (0.0), Type::DOUBLE, true, false, false, NULL, NULL, false, false);
	Canvas::TopProperty = DependencyProperty::RegisterFull (this, Type::CANVAS, "Top", new Value (0.0), Type::DOUBLE, true, false, false, NULL, NULL, false, false);
	Canvas::ZIndexProperty = DependencyProperty::RegisterFull (this, Type::CANVAS, "ZIndex", new Value (0), Type::INT32, true, false, false, NULL, NULL, false, false);
	...
	ColorAnimationUsingKeyFrames::KeyFramesProperty = DependencyProperty::Register (this, Type::COLORANIMATIONUSINGKEYFRAMES, "KeyFrames", Type::COLORKEYFRAME_COLLECTION);
	...
	Control::TemplateProperty = DependencyProperty::RegisterFull (this, Type::CONTROL, "Template", NULL, Type::CONTROLTEMPLATE, false, false, false, NULL, Validators::TemplateValidator, false, false);
	...
	DoubleAnimationUsingKeyFrames::KeyFramesProperty = DependencyProperty::Register (this, Type::DOUBLEANIMATIONUSINGKEYFRAMES, "KeyFrames", Type::DOUBLEKEYFRAME_COLLECTION);
	...
	EventTrigger::ActionsProperty = DependencyProperty::Register (this, Type::EVENTTRIGGER, "Actions", Type::TRIGGERACTION_COLLECTION);
	...
	FrameworkElement::LanguageProperty = DependencyProperty::RegisterFull (this, Type::FRAMEWORKELEMENT, "Language", new Value ("en-US"), Type::STRING, false, false, false, NULL, Validators::NonNullStringValidator, false, false);
	...
	FrameworkElement::StyleProperty = DependencyProperty::RegisterFull (this, Type::FRAMEWORKELEMENT, "Style", NULL, Type::STYLE, false, false, false, NULL, Validators::StyleValidator, false, false);
	...
	GeometryGroup::ChildrenProperty = DependencyProperty::Register (this, Type::GEOMETRYGROUP, "Children", Type::GEOMETRY_COLLECTION);
	...
	Glyphs::FontUriProperty = DependencyProperty::RegisterFull (this, Type::GLYPHS, "FontUri", NULL, Type::STRING, false, false, false, NULL, Validators::NonNullStringValidator, false, false);
	...
	GradientBrush::GradientStopsProperty = DependencyProperty::Register (this, Type::GRADIENTBRUSH, "GradientStops", Type::GRADIENTSTOP_COLLECTION);
	...
	Grid::ColumnDefinitionsProperty = DependencyProperty::Register (this, Type::GRID, "ColumnDefinitions", Type::COLUMNDEFINITION_COLLECTION);
	Grid::ColumnProperty = DependencyProperty::RegisterFull (this, Type::GRID, "Column", new Value (0), Type::INT32, true, false, false, NULL, Validators::PositiveIntValidator, false, false);
	Grid::ColumnSpanProperty = DependencyProperty::RegisterFull (this, Type::GRID, "ColumnSpan", new Value (1), Type::INT32, true, false, false, NULL, Validators::IntGreaterThanZeroValidator, false, false);
	Grid::RowDefinitionsProperty = DependencyProperty::Register (this, Type::GRID, "RowDefinitions", Type::ROWDEFINITION_COLLECTION);
	Grid::RowProperty = DependencyProperty::RegisterFull (this, Type::GRID, "Row", new Value (0), Type::INT32, true, false, false, NULL, Validators::PositiveIntValidator, false, false);
	Grid::RowSpanProperty = DependencyProperty::RegisterFull (this, Type::GRID, "RowSpan", new Value (1), Type::INT32, true, false, false, NULL, Validators::IntGreaterThanZeroValidator, false, false);
	...
	InkPresenter::StrokesProperty = DependencyProperty::Register (this, Type::INKPRESENTER, "Strokes", Type::STROKE_COLLECTION);
	...
	Inline::LanguageProperty = DependencyProperty::RegisterFull (this, Type::INLINE, "Language", new Value ("en-US"), Type::STRING, false, false, false, NULL, Validators::NonNullStringValidator, false, false);
	...
	InputMethod::IsInputMethodEnabledProperty = DependencyProperty::RegisterFull (this, Type::INPUTMETHOD, "IsInputMethodEnabled", NULL, Type::BOOL, true, false, false, NULL, NULL, false, false);
	...
	LayoutInformation::LastArrangeProperty = DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LastArrange", NULL, Type::SIZE, true, false, false, NULL, NULL, false, false);
	LayoutInformation::LastMeasureProperty = DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LastMeasure", NULL, Type::SIZE, true, false, false, NULL, NULL, false, false);
	LayoutInformation::LayoutClipProperty = DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LayoutClip", NULL, Type::GEOMETRY, true, false, false, NULL, NULL, false, false);
	LayoutInformation::LayoutSlotProperty = DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LayoutSlot", NULL, Type::RECT, true, false, false, NULL, NULL, false, false);
	...
	MediaBase::SourceProperty = DependencyProperty::RegisterFull (this, Type::MEDIABASE, "Source", NULL, Type::STRING, false, false, true, NULL, NULL, false, false);
	MediaBase::StretchProperty = DependencyProperty::Register (this, Type::MEDIABASE, "Stretch", new Value (StretchUniform), Type::INT32);
	MediaElement::AttributesProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "Attributes", NULL, Type::MEDIAATTRIBUTE_COLLECTION, false, false, false, NULL, Validators::MediaAttributeCollectionValidator, false, false);
	MediaElement::AudioStreamCountProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "AudioStreamCount", new Value (0), Type::INT32, false, true, false, NULL, NULL, false, false);
	MediaElement::AudioStreamIndexProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "AudioStreamIndex", NULL, Type::INT32, false, false, false, NULL, Validators::AudioStreamIndexValidator, false, true);
	...
	MediaElement::BufferingProgressProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "BufferingProgress", new Value (0.0), Type::DOUBLE, false, true, false, NULL, NULL, false, false);
	MediaElement::BufferingTimeProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "BufferingTime", new Value (TimeSpan_FromSeconds (5),Type::TIMESPAN), Type::TIMESPAN, false, false, false, NULL, Validators::BufferingTimeValidator, false, false);
	MediaElement::CanPauseProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "CanPause", new Value (false), Type::BOOL, false, true, false, NULL, NULL, false, false);
	MediaElement::CanSeekProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "CanSeek", new Value (false), Type::BOOL, false, true, false, NULL, NULL, false, false);
	MediaElement::CurrentStateProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "CurrentState", NULL, Type::INT32, false, true, false, NULL, NULL, false, false);
	MediaElement::DownloadProgressOffsetProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "DownloadProgressOffset", new Value (0.0), Type::DOUBLE, false, true, false, NULL, NULL, false, false);
	...
	MediaElement::DroppedFramesPerSecondProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "DroppedFramesPerSecond", new Value (0.0), Type::DOUBLE, false, true, false, NULL, NULL, false, false);
	MediaElement::IsMutedProperty = DependencyProperty::Register (this, Type::MEDIAELEMENT, "IsMuted", new Value (false), Type::BOOL);
	MediaElement::MarkersProperty = DependencyProperty::Register (this, Type::MEDIAELEMENT, "Markers", Type::TIMELINEMARKER_COLLECTION);
	MediaElement::NaturalDurationProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "NaturalDuration", new Value (Duration::FromSeconds (0)), Type::DURATION, false, true, false, NULL, NULL, false, false);
	MediaElement::NaturalVideoHeightProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "NaturalVideoHeight", new Value (0.0), Type::DOUBLE, false, true, false, NULL, Validators::DoubleGreaterThanZeroValidator, false, false);
	MediaElement::NaturalVideoWidthProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "NaturalVideoWidth", new Value (0.0), Type::DOUBLE, false, true, false, NULL, Validators::DoubleGreaterThanZeroValidator, false, false);
	MediaElement::PositionProperty = DependencyProperty::Register (this, Type::MEDIAELEMENT, "Position", Type::TIMESPAN);
	MediaElement::RenderedFramesPerSecondProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "RenderedFramesPerSecond", new Value (0.0), Type::DOUBLE, false, true, false, NULL, NULL, false, false);
	MediaElement::SourceProperty = DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "Source", NULL, Type::STRING, false, false, true, NULL, NULL, false, false);
	...
	MultiScaleSubImage::AspectRatioProperty = DependencyProperty::RegisterFull (this, Type::MULTISCALESUBIMAGE, "AspectRatio", new Value (1.0), Type::DOUBLE, false, true, false, NULL, NULL, false, false);
	...
	NameScope::NameScopeProperty = DependencyProperty::RegisterFull (this, Type::NAMESCOPE, "NameScope", NULL, Type::NAMESCOPE, true, false, false, NULL, NULL, false, false);
	...
	Panel::ChildrenProperty = DependencyProperty::Register (this, Type::PANEL, "Children", Type::UIELEMENT_COLLECTION);
	PasswordBox::MaxLengthProperty = DependencyProperty::RegisterFull (this, Type::PASSWORDBOX, "MaxLength", new Value (0), Type::INT32, false, false, false, NULL, Validators::IntGreaterThanZeroValidator, false, false);
	PasswordBox::PasswordCharProperty = DependencyProperty::Register (this, Type::PASSWORDBOX, "PasswordChar", new Value (9679), Type::CHAR);
	PasswordBox::PasswordProperty = DependencyProperty::RegisterFull (this, Type::PASSWORDBOX, "Password", new Value (""), Type::STRING, false, false, false, NULL, Validators::PasswordValidator, false, false);
	...
	PathFigure::SegmentsProperty = DependencyProperty::Register (this, Type::PATHFIGURE, "Segments", Type::PATHSEGMENT_COLLECTION);
	...
	PointAnimationUsingKeyFrames::KeyFramesProperty = DependencyProperty::Register (this, Type::POINTANIMATIONUSINGKEYFRAMES, "KeyFrames", Type::POINTKEYFRAME_COLLECTION);
	...
	Setter::PropertyProperty = DependencyProperty::RegisterFull (this, Type::SETTER, "Property", NULL, Type::DEPENDENCYPROPERTY, false, false, false, NULL, Validators::IsSetterSealedValidator, false, false);
	Setter::ValueProperty = DependencyProperty::RegisterFull (this, Type::SETTER, "Value", NULL, Type::OBJECT, false, false, false, NULL, Validators::IsSetterSealedValidator, false, false);
	...
	SplineColorKeyFrame::KeySplineProperty = DependencyProperty::Register (this, Type::SPLINECOLORKEYFRAME, "KeySpline", Type::KEYSPLINE);
	SplineDoubleKeyFrame::KeySplineProperty = DependencyProperty::Register (this, Type::SPLINEDOUBLEKEYFRAME, "KeySpline", Type::KEYSPLINE);
	SplinePointKeyFrame::KeySplineProperty = DependencyProperty::Register (this, Type::SPLINEPOINTKEYFRAME, "KeySpline", Type::KEYSPLINE);
	Storyboard::TargetNameProperty = DependencyProperty::RegisterFull (this, Type::STORYBOARD, "TargetName", NULL, Type::STRING, true, false, false, NULL, Validators::IsTimelineValidator, false, false);
	Storyboard::TargetPropertyProperty = DependencyProperty::RegisterFull (this, Type::STORYBOARD, "TargetProperty", NULL, Type::PROPERTYPATH, true, false, false, NULL, Validators::IsTimelineValidator, false, false);
	Stroke::DrawingAttributesProperty = DependencyProperty::Register (this, Type::STROKE, "DrawingAttributes", Type::DRAWINGATTRIBUTES);
	Stroke::StylusPointsProperty = DependencyProperty::Register (this, Type::STROKE, "StylusPoints", Type::STYLUSPOINT_COLLECTION);
	Style::IsSealedProperty = DependencyProperty::Register (this, Type::STYLE, "IsSealed", new Value (false), Type::BOOL);
	Style::SettersProperty = DependencyProperty::Register (this, Type::STYLE, "Setters", Type::SETTERBASE_COLLECTION);
	...
	TextBlock::InlinesProperty = DependencyProperty::Register (this, Type::TEXTBLOCK, "Inlines", Type::INLINE_COLLECTION);
	...
	TextBlock::TextProperty = DependencyProperty::Register (this, Type::TEXTBLOCK, "Text", Type::STRING);
	...
	TextBox::MaxLengthProperty = DependencyProperty::RegisterFull (this, Type::TEXTBOX, "MaxLength", new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, false, false);
	...
	TextBox::SelectionLengthProperty = DependencyProperty::RegisterFull (this, Type::TEXTBOX, "SelectionLength", new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, false, false);
	TextBox::SelectionStartProperty = DependencyProperty::RegisterFull (this, Type::TEXTBOX, "SelectionStart", new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, false, false);
	...
	TimelineGroup::ChildrenProperty = DependencyProperty::Register (this, Type::TIMELINEGROUP, "Children", Type::TIMELINE_COLLECTION);
	...
	TransformGroup::ChildrenProperty = DependencyProperty::Register (this, Type::TRANSFORMGROUP, "Children", Type::TRANSFORM_COLLECTION);
	...
	UIElement::CursorProperty = DependencyProperty::RegisterFull (this, Type::UIELEMENT, "Cursor", new Value (MouseCursorDefault), Type::INT32, false, false, false, NULL, Validators::CursorValidator, false, false);
	...
	UIElement::ResourcesProperty = DependencyProperty::Register (this, Type::UIELEMENT, "Resources", Type::RESOURCE_DICTIONARY);
	UIElement::TagProperty = DependencyProperty::Register (this, Type::UIELEMENT, "Tag", Type::STRING);
	UIElement::TriggersProperty = DependencyProperty::Register (this, Type::UIELEMENT, "Triggers", Type::TRIGGER_COLLECTION);
