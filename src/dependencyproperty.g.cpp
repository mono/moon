...
dependency_property_g_init (void)
{
	...
	Inline::ForegroundProperty = DependencyProperty::Register (Type::INLINE, "Foreground", new Value (new SolidColorBrush("black")));
	...
	TextBox::SelectedTextProperty = DependencyProperty::Register (Type::TEXTBOX, "SelectedText", new Value (""));
