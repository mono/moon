...
{
	DependencyProperty::Register (this, Type::VISUALBRUSH, "Visual", true, Type::UIELEMENT);
	DependencyProperty::Register (this, Type::VIDEOBRUSH, "SourceName", true, new Value (""), Type::STRING);
	DependencyProperty::Register (this, Type::IMAGEBRUSH, "ImageSource", true, Type::IMAGESOURCE);
	DependencyProperty::Register (this, Type::IMAGEBRUSH, "DownloadProgress", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::RADIALGRADIENTBRUSH, "RadiusY", true, new Value (0.5), Type::DOUBLE);
	DependencyProperty::Register (this, Type::RADIALGRADIENTBRUSH, "RadiusX", true, new Value (0.5), Type::DOUBLE);
	DependencyProperty::Register (this, Type::RADIALGRADIENTBRUSH, "GradientOrigin", true, new Value (Point (0.5, 0.5)), Type::POINT);
	DependencyProperty::Register (this, Type::RADIALGRADIENTBRUSH, "Center", true, new Value (Point (0.5, 0.5)), Type::POINT);
	DependencyProperty::Register (this, Type::LINEARGRADIENTBRUSH, "StartPoint", true, Type::POINT);
	DependencyProperty::Register (this, Type::LINEARGRADIENTBRUSH, "EndPoint", true, new Value (Point(1,1)), Type::POINT);
	DependencyProperty::Register (this, Type::SOLIDCOLORBRUSH, "Color", true, new Value (Color (0x00000000)), Type::COLOR);
	DependencyProperty::Register (this, Type::TILEBRUSH, "Stretch", true, new Value (StretchFill), Type::INT32);
	DependencyProperty::Register (this, Type::TILEBRUSH, "AlignmentY", true, new Value (AlignmentYCenter), Type::INT32);
	DependencyProperty::Register (this, Type::TILEBRUSH, "AlignmentX", true, new Value (AlignmentXCenter), Type::INT32);
	DependencyProperty::Register (this, Type::GRADIENTBRUSH, "SpreadMethod", true, new Value (GradientSpreadMethodPad), Type::INT32);
	DependencyProperty::Register (this, Type::GRADIENTBRUSH, "MappingMode", true, new Value (BrushMappingModeRelativeToBoundingBox), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::GRADIENTBRUSH, "GradientStops", true, NULL, Type::GRADIENTSTOP_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::GRADIENTBRUSH, "ColorInterpolationMode", true, new Value (ColorInterpolationModeSRgbLinearInterpolation), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::INKPRESENTER, "Strokes", true, NULL, Type::STROKE_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::BRUSH, "Transform", true, new Value (new MatrixTransform ()), Type::TRANSFORM);
	DependencyProperty::Register (this, Type::BRUSH, "RelativeTransform", true, new Value (new MatrixTransform ()), Type::TRANSFORM);
	DependencyProperty::Register (this, Type::BRUSH, "Opacity", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::BRUSH, "Changed", true, Type::BOOL);
	DependencyProperty::Register (this, Type::RECTANGLE, "RadiusY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::RECTANGLE, "RadiusX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::RegisterFull (this, Type::POLYLINE, "Points", true, NULL, Type::POINT_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::POLYLINE, "FillRule", true, new Value (FillRuleEvenOdd), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::POLYGON, "Points", true, NULL, Type::POINT_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::POLYGON, "FillRule", true, new Value (FillRuleEvenOdd), Type::INT32);
	DependencyProperty::Register (this, Type::PATH, "Data", true, Type::GEOMETRY);
	DependencyProperty::Register (this, Type::LINE, "Y2", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::LINE, "Y1", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::LINE, "X2", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::LINE, "X1", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "ViewportWidth", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "ViewportOrigin", true, new Value (Point(0,0)), Type::POINT);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "UseSprings", true, new Value (true), Type::BOOL);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "TileFade", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::RegisterFull (this, Type::MULTISCALEIMAGE, "SubImages", true, NULL, Type::MULTISCALESUBIMAGE_COLLECTION, false, true, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "Source", true, Type::MULTISCALETILESOURCE);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "IsIdle", true, new Value (true), Type::BOOL);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "IsDownloading", true, new Value (false), Type::BOOL);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "BlurFactor", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "AspectRatio", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MULTISCALEIMAGE, "AllowDownloading", true, new Value (true), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::IMAGE, "Source", true, NULL, Type::IMAGESOURCE, false, false, false, NULL, NULL, Image::CreateDefaultImageSource, false, false);
	DependencyProperty::Register (this, Type::USERCONTROL, "Content", true, Type::UIELEMENT);
	DependencyProperty::Register (this, Type::CONTENTCONTROL, "ContentTemplate", true, Type::DATATEMPLATE);
	DependencyProperty::RegisterFull (this, Type::CONTENTCONTROL, "Content", true, NULL, Type::OBJECT, false, false, false, NULL, Validators::ContentControlContentValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::GRID, "ShowGridLines", true, new Value (true), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::GRID, "RowSpan", true, new Value (1), Type::INT32, true, false, false, NULL, Validators::IntGreaterThanZeroValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::GRID, "Row", true, new Value (0), Type::INT32, true, false, false, NULL, Validators::PositiveIntValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::GRID, "RowDefinitions", true, NULL, Type::ROWDEFINITION_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::GRID, "ColumnSpan", true, new Value (1), Type::INT32, true, false, false, NULL, Validators::IntGreaterThanZeroValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::GRID, "Column", true, new Value (0), Type::INT32, true, false, false, NULL, Validators::PositiveIntValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::GRID, "ColumnDefinitions", true, NULL, Type::COLUMNDEFINITION_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::CANVAS, "ZIndex", true, new Value (0), Type::INT32, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::CANVAS, "Top", true, new Value (0.0), Type::DOUBLE, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::CANVAS, "Left", true, new Value (0.0), Type::DOUBLE, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "TextWrapping", true, new Value (TextWrappingNoWrap), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "Text", true, new Value (""), Type::STRING);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "TextDecorations", true, new Value (TextDecorationsNone), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "TextAlignment", true, new Value (TextAlignmentLeft), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "Padding", true, new Value (Thickness (0)), Type::THICKNESS);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "LineStackingStrategy", true, new Value (LineStackingStrategyMaxHeight), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "LineHeight", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::RegisterFull (this, Type::TEXTBLOCK, "Inlines", true, NULL, Type::INLINE_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "Foreground", true, new Value (new SolidColorBrush("black")), Type::BRUSH);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "FontWeight", true, new Value (TEXTBLOCK_FONT_WEIGHT), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "FontStyle", true, new Value (TEXTBLOCK_FONT_STYLE), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "FontStretch", true, new Value (TEXTBLOCK_FONT_STRETCH), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "FontSource", true, Type::FONTSOURCE);
	DependencyProperty::RegisterFull (this, Type::TEXTBLOCK, "FontSize", true, NULL, Type::DOUBLE, false, false, false, NULL, NULL, AutoCreators::CreateDefaultFontSize, false, false);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "FontGUID", true, Type::STRING);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "FontFilename", true, Type::STRING);
	DependencyProperty::Register (this, Type::TEXTBLOCK, "FontFamily", true, new Value (FontFamily(TEXTBLOCK_FONT_FAMILY)), Type::FONTFAMILY);
	DependencyProperty::Register (this, Type::POPUP, "VerticalOffset", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::POPUP, "IsOpen", true, new Value (false), Type::BOOL);
	DependencyProperty::Register (this, Type::POPUP, "HorizontalOffset", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::RegisterFull (this, Type::POPUP, "Child", true, NULL, Type::UIELEMENT, false, false, false, NULL, Validators::ContentControlContentValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::MEDIAELEMENT, "Volume", true, new Value (0.5), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MEDIAELEMENT, "Stretch", true, new Value (StretchUniform), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "Source", true, NULL, Type::URI, false, false, true, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "RenderedFramesPerSecond", true, new Value (0.0), Type::DOUBLE, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "Position", true, NULL, Type::TIMESPAN, false, false, true, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "NaturalVideoWidth", true, new Value (0), Type::INT32, false, true, false, NULL, Validators::IntGreaterThanZeroValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "NaturalVideoHeight", true, new Value (0), Type::INT32, false, true, false, NULL, Validators::IntGreaterThanZeroValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "NaturalDuration", true, new Value (Duration::FromSeconds (0)), Type::DURATION, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "Markers", true, NULL, Type::TIMELINEMARKER_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::MEDIAELEMENT, "IsMuted", true, new Value (false), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "DroppedFramesPerSecond", true, new Value (0.0), Type::DOUBLE, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::Register (this, Type::MEDIAELEMENT, "DownloadProgress", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "DownloadProgressOffset", true, new Value (0.0), Type::DOUBLE, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "CurrentState", true, new Value (MediaStateClosed), Type::INT32, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "CanSeek", true, new Value (false), Type::BOOL, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "CanPause", true, new Value (false), Type::BOOL, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "BufferingTime", true, NULL, Type::TIMESPAN, false, false, false, NULL, Validators::BufferingTimeValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "BufferingProgress", true, new Value (0.0), Type::DOUBLE, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::Register (this, Type::MEDIAELEMENT, "Balance", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MEDIAELEMENT, "AutoPlay", true, new Value (true), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "AudioStreamIndex", true, NULL, Type::INT32, false, false, false, NULL, Validators::AudioStreamIndexValidator, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "AudioStreamCount", true, new Value (0), Type::INT32, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::MEDIAELEMENT, "Attributes", true, NULL, Type::MEDIAATTRIBUTE_COLLECTION, false, false, false, NULL, Validators::MediaAttributeCollectionValidator, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::SHAPE, "StrokeThickness", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SHAPE, "StrokeStartLineCap", true, new Value (PenLineCapFlat), Type::INT32);
	DependencyProperty::Register (this, Type::SHAPE, "Stroke", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::SHAPE, "StrokeMiterLimit", true, new Value (10.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SHAPE, "StrokeLineJoin", true, new Value (PenLineJoinMiter), Type::INT32);
	DependencyProperty::Register (this, Type::SHAPE, "StrokeEndLineCap", true, new Value (PenLineCapFlat), Type::INT32);
	DependencyProperty::Register (this, Type::SHAPE, "StrokeDashOffset", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SHAPE, "StrokeDashCap", true, new Value (PenLineCapFlat), Type::INT32);
	DependencyProperty::Register (this, Type::SHAPE, "StrokeDashArray", true, Type::DOUBLE_COLLECTION);
	DependencyProperty::RegisterFull (this, Type::SHAPE, "Stretch", true, NULL, Type::INT32, false, false, false, NULL, NULL, Shape::CreateDefaultStretch, false, false);
	DependencyProperty::Register (this, Type::SHAPE, "Fill", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::MEDIABASE, "Stretch", true, new Value (StretchUniform), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::MEDIABASE, "Source", true, NULL, Type::STRING, false, false, true, NULL, NULL, NULL, false, false);
	DependencyProperty::Register (this, Type::MEDIABASE, "DownloadProgress", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::GLYPHS, "UnicodeString", true, new Value (""), Type::STRING);
	DependencyProperty::Register (this, Type::GLYPHS, "StyleSimulations", true, new Value (StyleSimulationsNone), Type::INT32);
	DependencyProperty::Register (this, Type::GLYPHS, "OriginY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::GLYPHS, "OriginX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::GLYPHS, "Indices", true, new Value (""), Type::STRING);
	DependencyProperty::RegisterFull (this, Type::GLYPHS, "FontUri", true, new Value (Uri()), Type::URI, false, false, false, NULL, Validators::NonNullValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::GLYPHS, "FontRenderingEmSize", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::GLYPHS, "Fill", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::CONTROL, "VerticalContentAlignment", true, new Value (VerticalAlignmentCenter), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::CONTROL, "Template", true, NULL, Type::CONTROLTEMPLATE, false, false, false, NULL, Validators::TemplateValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::CONTROL, "TabNavigation", true, new Value (KeyboardNavigationModeLocal), Type::INT32);
	DependencyProperty::Register (this, Type::CONTROL, "TabIndex", true, new Value (INT_MAX), Type::INT32);
	DependencyProperty::Register (this, Type::CONTROL, "Padding", true, new Value (Thickness(0.0)), Type::THICKNESS);
	DependencyProperty::Register (this, Type::CONTROL, "IsTabStop", true, new Value (true), Type::BOOL);
	DependencyProperty::Register (this, Type::CONTROL, "HorizontalContentAlignment", true, new Value (HorizontalAlignmentCenter), Type::INT32);
	DependencyProperty::Register (this, Type::CONTROL, "Foreground", true, new Value (new SolidColorBrush("black")), Type::BRUSH);
	DependencyProperty::Register (this, Type::CONTROL, "FontWeight", true, new Value (CONTROL_FONT_WEIGHT), Type::INT32);
	DependencyProperty::Register (this, Type::CONTROL, "FontStyle", true, new Value (CONTROL_FONT_STYLE), Type::INT32);
	DependencyProperty::Register (this, Type::CONTROL, "FontStretch", true, new Value (CONTROL_FONT_STRETCH), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::CONTROL, "FontSize", true, NULL, Type::DOUBLE, false, false, false, NULL, NULL, AutoCreators::CreateDefaultFontSize, false, false);
	DependencyProperty::Register (this, Type::CONTROL, "FontFamily", true, new Value (FontFamily(CONTROL_FONT_FAMILY)), Type::FONTFAMILY);
	DependencyProperty::Register (this, Type::CONTROL, "DefaultStyleKey", true, Type::MANAGEDTYPEINFO);
	DependencyProperty::Register (this, Type::CONTROL, "BorderThickness", true, new Value (Thickness(0.0)), Type::THICKNESS);
	DependencyProperty::Register (this, Type::CONTROL, "BorderBrush", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::CONTROL, "Background", true, Type::BRUSH);
	DependencyProperty::RegisterFull (this, Type::PANEL, "Children", true, NULL, Type::UIELEMENT_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::PANEL, "Background", true, Type::BRUSH);
	DependencyProperty::RegisterFull (this, Type::BORDER, "Padding", true, new Value (Thickness(0)), Type::THICKNESS, false, false, false, NULL, Validators::BorderThicknessValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::BORDER, "CornerRadius", true, NULL, Type::CORNERRADIUS, false, false, false, NULL, Validators::CornerRadiusValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::BORDER, "Child", true, Type::UIELEMENT);
	DependencyProperty::RegisterFull (this, Type::BORDER, "BorderThickness", true, new Value (Thickness(0)), Type::THICKNESS, false, false, false, NULL, Validators::BorderThicknessValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::BORDER, "BorderBrush", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::BORDER, "Background", true, Type::BRUSH);
	DependencyProperty::RegisterFull (this, Type::TIMELINEGROUP, "Children", true, NULL, Type::TIMELINE_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::SETTER, "Value", true, NULL, Type::OBJECT, false, false, false, NULL, Validators::IsSetterSealedValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::SETTER, "Property", true, NULL, Type::DEPENDENCYPROPERTY, false, false, false, NULL, Validators::IsSetterSealedValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::SETTER, "ConvertedValue", true, Type::OBJECT);
	DependencyProperty::Register (this, Type::RUN, "Text", true, Type::STRING);
	DependencyProperty::Register (this, Type::RECTANGLEGEOMETRY, "Rect", true, Type::RECT);
	DependencyProperty::Register (this, Type::RECTANGLEGEOMETRY, "RadiusY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::RECTANGLEGEOMETRY, "RadiusX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::PATHGEOMETRY, "FillRule", true, new Value (FillRuleEvenOdd), Type::INT32);
	DependencyProperty::Register (this, Type::PATHGEOMETRY, "Figures", true, Type::PATHFIGURE_COLLECTION);
	DependencyProperty::Register (this, Type::LINEGEOMETRY, "StartPoint", true, Type::POINT);
	DependencyProperty::Register (this, Type::LINEGEOMETRY, "EndPoint", true, Type::POINT);
	DependencyProperty::Register (this, Type::GEOMETRYGROUP, "FillRule", true, new Value (FillRuleEvenOdd), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::GEOMETRYGROUP, "Children", true, NULL, Type::GEOMETRY_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::ELLIPSEGEOMETRY, "RadiusY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ELLIPSEGEOMETRY, "RadiusX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ELLIPSEGEOMETRY, "Center", true, Type::POINT);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "Width", true, new Value (NAN), Type::DOUBLE);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "VerticalAlignment", true, new Value (VerticalAlignmentStretch), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::FRAMEWORKELEMENT, "Style", true, NULL, Type::STYLE, false, false, false, NULL, Validators::StyleValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "MinWidth", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "MinHeight", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "MaxWidth", true, new Value (INFINITY), Type::DOUBLE);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "MaxHeight", true, new Value (INFINITY), Type::DOUBLE);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "Margin", true, new Value (Thickness (0)), Type::THICKNESS);
	DependencyProperty::RegisterFull (this, Type::FRAMEWORKELEMENT, "Language", true, new Value ("en-US"), Type::STRING, false, false, false, NULL, Validators::NonNullValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "HorizontalAlignment", true, new Value (HorizontalAlignmentStretch), Type::INT32);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "Height", true, new Value (NAN), Type::DOUBLE);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "DataContext", true, Type::OBJECT);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "ActualWidth", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::FRAMEWORKELEMENT, "ActualHeight", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::POWEREASE, "Power", true, new Value (2.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::EXPONENTIALEASE, "Exponent", true, new Value (2.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ELASTICEASE, "Springiness", true, new Value (3.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ELASTICEASE, "Oscillations", true, new Value (3), Type::INT32);
	DependencyProperty::Register (this, Type::BOUNCEEASE, "Bounciness", true, new Value (2.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::BOUNCEEASE, "Bounces", true, new Value (3), Type::INT32);
	DependencyProperty::Register (this, Type::BACKEASE, "Amplitude", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::RegisterFull (this, Type::SPLINEPOINTKEYFRAME, "KeySpline", true, NULL, Type::KEYSPLINE, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::EASINGPOINTKEYFRAME, "EasingFunction", true, Type::EASINGFUNCTIONBASE);
	DependencyProperty::RegisterFull (this, Type::POINTANIMATIONUSINGKEYFRAMES, "KeyFrames", true, NULL, Type::POINTKEYFRAME_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::SPLINEDOUBLEKEYFRAME, "KeySpline", true, NULL, Type::KEYSPLINE, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::EASINGDOUBLEKEYFRAME, "EasingFunction", true, Type::EASINGFUNCTIONBASE);
	DependencyProperty::RegisterFull (this, Type::DOUBLEANIMATIONUSINGKEYFRAMES, "KeyFrames", true, NULL, Type::DOUBLEKEYFRAME_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::TIMELINEMARKER, "Type", true, Type::STRING);
	DependencyProperty::Register (this, Type::TIMELINEMARKER, "Time", true, Type::TIMESPAN);
	DependencyProperty::Register (this, Type::TIMELINEMARKER, "Text", true, Type::STRING);
	DependencyProperty::Register (this, Type::TIMELINE, "SpeedRatio", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::TIMELINE, "RepeatBehavior", true, new Value (RepeatBehavior ((double) 1)), Type::REPEATBEHAVIOR);
	DependencyProperty::Register (this, Type::TIMELINE, "FillBehavior", true, new Value (FillBehaviorHoldEnd), Type::INT32);
	DependencyProperty::Register (this, Type::TIMELINE, "Duration", true, new Value (Duration::Automatic), Type::DURATION);
	DependencyProperty::RegisterFull (this, Type::TIMELINE, "BeginTime", true, new Value (0,Type::TIMESPAN), Type::TIMESPAN, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::Register (this, Type::TIMELINE, "AutoReverse", true, new Value (false), Type::BOOL);
	DependencyProperty::Register (this, Type::STYLUSPOINT, "Y", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::STYLUSPOINT, "X", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::STYLUSPOINT, "PressureFactor", true, new Value (0.5), Type::DOUBLE);
	DependencyProperty::Register (this, Type::STYLUSINFO, "IsInverted", true, new Value (false), Type::BOOL);
	DependencyProperty::Register (this, Type::STYLUSINFO, "DeviceType", true, new Value (TabletDeviceTypeMouse), Type::INT32);
	DependencyProperty::Register (this, Type::STYLE, "TargetType", true, Type::MANAGEDTYPEINFO);
	DependencyProperty::RegisterFull (this, Type::STYLE, "Setters", true, NULL, Type::SETTERBASE_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::STYLE, "IsSealed", true, new Value (false), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::STROKE, "StylusPoints", true, NULL, Type::STYLUSPOINT_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::STROKE, "DrawingAttributes", true, NULL, Type::DRAWINGATTRIBUTES, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::SETTERBASE, "IsSealed", true, new Value (false), Type::BOOL);
	DependencyProperty::Register (this, Type::ROWDEFINITION, "MinHeight", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ROWDEFINITION, "MaxHeight", true, new Value (INFINITY), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ROWDEFINITION, "Height", true, new Value (GridLength (1.0, GridUnitTypeStar)), Type::GRIDLENGTH);
	DependencyProperty::Register (this, Type::PATHFIGURE, "StartPoint", true, Type::POINT);
	DependencyProperty::RegisterFull (this, Type::PATHFIGURE, "Segments", true, NULL, Type::PATHSEGMENT_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::PATHFIGURE, "IsFilled", true, new Value (true), Type::BOOL);
	DependencyProperty::Register (this, Type::PATHFIGURE, "IsClosed", true, new Value (false), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::NAMESCOPE, "NameScope", true, NULL, Type::NAMESCOPE, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::Register (this, Type::MULTISCALESUBIMAGE, "ZIndex", true, new Value (0), Type::INT32);
	DependencyProperty::Register (this, Type::MULTISCALESUBIMAGE, "ViewportWidth", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MULTISCALESUBIMAGE, "ViewportOrigin", true, new Value (Point(0,0)), Type::POINT);
	DependencyProperty::Register (this, Type::MULTISCALESUBIMAGE, "Opacity", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::RegisterFull (this, Type::MULTISCALESUBIMAGE, "AspectRatio", true, new Value (1.0), Type::DOUBLE, false, true, false, NULL, NULL, NULL, false, false);
	DependencyProperty::Register (this, Type::MEDIAATTRIBUTE, "Value", true, Type::STRING);
	DependencyProperty::Register (this, Type::MATRIX, "OffsetY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MATRIX, "OffsetX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MATRIX, "M22", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MATRIX, "M21", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MATRIX, "M12", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::MATRIX, "M11", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::KEYSPLINE, "ControlPoint2", true, new Value (Point (1.0, 1.0)), Type::POINT);
	DependencyProperty::Register (this, Type::KEYSPLINE, "ControlPoint1", true, new Value (Point (0,0)), Type::POINT);
	DependencyProperty::RegisterFull (this, Type::INPUTMETHOD, "IsInputMethodEnabled", true, NULL, Type::BOOL, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::Register (this, Type::INLINE, "TextDecorations", true, new Value (TextDecorationsNone), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::INLINE, "Language", true, new Value ("en-US"), Type::STRING, false, false, false, NULL, Validators::NonNullValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::INLINE, "Foreground", true, new Value (new SolidColorBrush("black")), Type::BRUSH);
	DependencyProperty::Register (this, Type::INLINE, "FontWeight", true, new Value (TEXTBLOCK_FONT_WEIGHT), Type::INT32);
	DependencyProperty::Register (this, Type::INLINE, "FontStyle", true, new Value (TEXTBLOCK_FONT_STYLE), Type::INT32);
	DependencyProperty::Register (this, Type::INLINE, "FontStretch", true, new Value (TEXTBLOCK_FONT_STRETCH), Type::INT32);
	DependencyProperty::Register (this, Type::INLINE, "FontSource", true, Type::FONTSOURCE);
	DependencyProperty::RegisterFull (this, Type::INLINE, "FontSize", true, NULL, Type::DOUBLE, false, false, false, NULL, NULL, AutoCreators::CreateDefaultFontSize, false, false);
	DependencyProperty::Register (this, Type::INLINE, "FontGUID", true, Type::STRING);
	DependencyProperty::Register (this, Type::INLINE, "FontFilename", true, Type::STRING);
	DependencyProperty::Register (this, Type::INLINE, "FontFamily", true, new Value (FontFamily(TEXTBLOCK_FONT_FAMILY)), Type::FONTFAMILY);
	DependencyProperty::Register (this, Type::GRADIENTSTOP, "Offset", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::GRADIENTSTOP, "Color", true, new Value (Color (0x00000000)), Type::COLOR);
	DependencyProperty::Register (this, Type::GEOMETRY, "Transform", true, Type::TRANSFORM);
	DependencyProperty::Register (this, Type::DRAWINGATTRIBUTES, "Width", true, new Value (3.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::DRAWINGATTRIBUTES, "OutlineColor", true, new Value (Color (0x00000000)), Type::COLOR);
	DependencyProperty::Register (this, Type::DRAWINGATTRIBUTES, "Height", true, new Value (3.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::DRAWINGATTRIBUTES, "Color", true, new Value (Color (0xFF000000)), Type::COLOR);
	DependencyProperty::Register (this, Type::DOWNLOADER, "Uri", true, Type::URI);
	DependencyProperty::Register (this, Type::DOWNLOADER, "StatusText", true, new Value (""), Type::STRING);
	DependencyProperty::Register (this, Type::DOWNLOADER, "Status", true, new Value (0), Type::INT32);
	DependencyProperty::Register (this, Type::DOWNLOADER, "ResponseText", true, Type::STRING);
	DependencyProperty::Register (this, Type::DOWNLOADER, "DownloadProgress", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::DEPLOYMENT, "Surface", true, Type::SURFACE);
	DependencyProperty::Register (this, Type::DEPLOYMENT, "RuntimeVersion", true, Type::STRING);
	DependencyProperty::Register (this, Type::DEPLOYMENT, "Parts", true, Type::ASSEMBLYPART_COLLECTION);
	DependencyProperty::Register (this, Type::DEPLOYMENT, "ExternalCallersFromCrossDomain", true, new Value (CrossDomainAccessNoAccess), Type::INT32);
	DependencyProperty::Register (this, Type::DEPLOYMENT, "EntryPointType", true, Type::STRING);
	DependencyProperty::Register (this, Type::DEPLOYMENT, "EntryPointAssembly", true, Type::STRING);
	DependencyProperty::Register (this, Type::COLUMNDEFINITION, "Width", true, new Value (GridLength (1.0, GridUnitTypeStar)), Type::GRIDLENGTH);
	DependencyProperty::Register (this, Type::COLUMNDEFINITION, "MinWidth", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::COLUMNDEFINITION, "MaxWidth", true, new Value (INFINITY), Type::DOUBLE);
	DependencyProperty::Register (this, Type::COLLECTION, "Count", true, new Value (0), Type::INT32);
	DependencyProperty::Register (this, Type::UIELEMENT, "Visibility", true, new Value (VisibilityVisible), Type::INT32);
	DependencyProperty::Register (this, Type::UIELEMENT, "UseLayoutRounding", true, new Value (true), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::UIELEMENT, "Triggers", true, NULL, Type::TRIGGER_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::UIELEMENT, "Tag", false, Type::OBJECT);
	DependencyProperty::RegisterFull (this, Type::UIELEMENT, "Resources", true, NULL, Type::RESOURCE_DICTIONARY, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::UIELEMENT, "RenderTransform", true, Type::TRANSFORM);
	DependencyProperty::Register (this, Type::UIELEMENT, "RenderTransformOrigin", true, new Value (Point (0,0)), Type::POINT);
	DependencyProperty::Register (this, Type::UIELEMENT, "Opacity", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::UIELEMENT, "OpacityMask", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::UIELEMENT, "IsHitTestVisible", true, new Value (true), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::UIELEMENT, "Cursor", true, new Value (MouseCursorDefault), Type::INT32, false, false, false, NULL, Validators::CursorValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::UIELEMENT, "Clip", true, Type::GEOMETRY);
	DependencyProperty::Register (this, Type::EASINGFUNCTIONBASE, "EasingMode", true, new Value (EasingModeOut), Type::INT32);
	DependencyProperty::Register (this, Type::ASSEMBLYPART, "Source", true, new Value (""), Type::STRING);
	DependencyProperty::RegisterFull (this, Type::APPLICATION, "Resources", true, NULL, Type::RESOURCE_DICTIONARY, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::SPLINECOLORKEYFRAME, "KeySpline", true, NULL, Type::KEYSPLINE, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::EASINGCOLORKEYFRAME, "EasingFunction", true, Type::EASINGFUNCTIONBASE);
	DependencyProperty::RegisterFull (this, Type::COLORANIMATIONUSINGKEYFRAMES, "KeyFrames", true, NULL, Type::COLORKEYFRAME_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::BITMAPIMAGE, "UriSource", true, new Value (Uri()), Type::URI);
	DependencyProperty::Register (this, Type::BITMAPIMAGE, "Progress", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::TRANSLATETRANSFORM, "Y", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::TRANSLATETRANSFORM, "X", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::RegisterFull (this, Type::TRANSFORMGROUP, "Children", true, NULL, Type::TRANSFORM_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::TEXTBOX, "VerticalScrollBarVisibility", true, new Value (ScrollBarVisibilityHidden), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBOX, "TextWrapping", true, new Value (TextWrappingNoWrap), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBOX, "Text", true, Type::STRING);
	DependencyProperty::Register (this, Type::TEXTBOX, "TextAlignment", true, new Value (TextAlignmentLeft), Type::INT32);
	DependencyProperty::RegisterFull (this, Type::TEXTBOX, "SelectionStart", true, new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::TEXTBOX, "SelectionLength", true, new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::TEXTBOX, "SelectionForeground", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::TEXTBOX, "SelectionBackground", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::TEXTBOX, "SelectedText", true, new Value (""), Type::STRING);
	DependencyProperty::RegisterFull (this, Type::TEXTBOX, "MaxLength", true, new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::TEXTBOX, "IsReadOnly", true, new Value (false), Type::BOOL);
	DependencyProperty::Register (this, Type::TEXTBOX, "HorizontalScrollBarVisibility", true, new Value (ScrollBarVisibilityHidden), Type::INT32);
	DependencyProperty::Register (this, Type::TEXTBOX, "FontSource", true, Type::FONTSOURCE);
	DependencyProperty::Register (this, Type::TEXTBOX, "AcceptsReturn", true, new Value (false), Type::BOOL);
	DependencyProperty::RegisterFull (this, Type::STORYBOARD, "TargetProperty", true, NULL, Type::PROPERTYPATH, true, false, false, NULL, Validators::IsTimelineValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::STORYBOARD, "TargetName", true, NULL, Type::STRING, true, false, false, NULL, Validators::IsTimelineValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::SKEWTRANSFORM, "CenterY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SKEWTRANSFORM, "CenterX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SKEWTRANSFORM, "AngleY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SKEWTRANSFORM, "AngleX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SETTERBASE_COLLECTION, "IsSealed", true, new Value (false), Type::BOOL);
	DependencyProperty::Register (this, Type::SCALETRANSFORM, "ScaleY", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SCALETRANSFORM, "ScaleX", true, new Value (1.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SCALETRANSFORM, "CenterY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::SCALETRANSFORM, "CenterX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ROTATETRANSFORM, "CenterY", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ROTATETRANSFORM, "CenterX", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ROTATETRANSFORM, "Angle", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::QUADRATICBEZIERSEGMENT, "Point2", true, Type::POINT);
	DependencyProperty::Register (this, Type::QUADRATICBEZIERSEGMENT, "Point1", true, Type::POINT);
	DependencyProperty::RegisterFull (this, Type::POLYQUADRATICBEZIERSEGMENT, "Points", true, NULL, Type::POINT_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::POLYLINESEGMENT, "Points", true, NULL, Type::POINT_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::POLYBEZIERSEGMENT, "Points", true, NULL, Type::POINT_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::POINTKEYFRAME, "Value", true, NULL, Type::POINT, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::POINTKEYFRAME, "KeyTime", true, NULL, Type::KEYTIME, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::POINTANIMATION, "To", true, NULL, Type::POINT, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::POINTANIMATION, "From", true, NULL, Type::POINT, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::Register (this, Type::POINTANIMATION, "EasingFunction", true, Type::EASINGFUNCTIONBASE);
	DependencyProperty::RegisterFull (this, Type::POINTANIMATION, "By", true, NULL, Type::POINT, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::PASSWORDBOX, "SelectionStart", true, new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::PASSWORDBOX, "SelectionLength", true, new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::PASSWORDBOX, "SelectionForeground", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::PASSWORDBOX, "SelectionBackground", true, Type::BRUSH);
	DependencyProperty::Register (this, Type::PASSWORDBOX, "SelectedText", true, new Value (""), Type::STRING);
	DependencyProperty::RegisterFull (this, Type::PASSWORDBOX, "Password", true, new Value (""), Type::STRING, false, false, false, NULL, Validators::NonNullValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::PASSWORDBOX, "PasswordChar", true, new Value (9679), Type::CHAR);
	DependencyProperty::RegisterFull (this, Type::PASSWORDBOX, "MaxLength", true, new Value (0), Type::INT32, false, false, false, NULL, Validators::PositiveIntValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::PASSWORDBOX, "FontSource", true, Type::FONTSOURCE);
	DependencyProperty::Register (this, Type::OBJECTKEYFRAME, "Value", true, Type::OBJECT);
	DependencyProperty::RegisterFull (this, Type::OBJECTKEYFRAME, "KeyTime", true, NULL, Type::KEYTIME, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::Register (this, Type::OBJECTKEYFRAME, "ConvertedValue", true, Type::OBJECT);
	DependencyProperty::RegisterFull (this, Type::OBJECTANIMATIONUSINGKEYFRAMES, "KeyFrames", true, NULL, Type::OBJECTKEYFRAME_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::Register (this, Type::MATRIXTRANSFORM, "Matrix", true, Type::MATRIX);
	DependencyProperty::Register (this, Type::LINESEGMENT, "Point", true, Type::POINT);
	DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LayoutSlot", true, NULL, Type::RECT, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LayoutClip", true, NULL, Type::GEOMETRY, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LastRenderSize", true, NULL, Type::SIZE, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LastMeasure", true, NULL, Type::SIZE, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::LAYOUTINFORMATION, "LastArrange", true, NULL, Type::SIZE, true, false, false, NULL, NULL, NULL, false, false);
	DependencyProperty::Register (this, Type::EVENTTRIGGER, "RoutedEvent", true, Type::STRING);
	DependencyProperty::RegisterFull (this, Type::EVENTTRIGGER, "Actions", true, NULL, Type::TRIGGERACTION_COLLECTION, false, false, false, NULL, NULL, AutoCreators::default_autocreator, false, false);
	DependencyProperty::RegisterFull (this, Type::DOUBLEKEYFRAME, "Value", true, NULL, Type::DOUBLE, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::DOUBLEKEYFRAME, "KeyTime", true, NULL, Type::KEYTIME, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::DOUBLEANIMATION, "To", true, NULL, Type::DOUBLE, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::DOUBLEANIMATION, "From", true, NULL, Type::DOUBLE, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::Register (this, Type::DOUBLEANIMATION, "EasingFunction", true, Type::EASINGFUNCTIONBASE);
	DependencyProperty::RegisterFull (this, Type::DOUBLEANIMATION, "By", true, NULL, Type::DOUBLE, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::DEPENDENCY_OBJECT, "Name", true, new Value (""), Type::STRING, false, false, false, NULL, Validators::NameValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::DEEPZOOMIMAGETILESOURCE, "UriSource", true, Type::URI);
	DependencyProperty::Register (this, Type::CONTROLTEMPLATE, "TargetType", true, Type::MANAGEDTYPEINFO);
	DependencyProperty::RegisterFull (this, Type::COLORKEYFRAME, "Value", true, NULL, Type::COLOR, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::COLORKEYFRAME, "KeyTime", true, NULL, Type::KEYTIME, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::COLORANIMATION, "To", true, NULL, Type::COLOR, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::COLORANIMATION, "From", true, NULL, Type::COLOR, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::Register (this, Type::COLORANIMATION, "EasingFunction", true, Type::EASINGFUNCTIONBASE);
	DependencyProperty::RegisterFull (this, Type::COLORANIMATION, "By", true, NULL, Type::COLOR, false, false, false, NULL, NULL, NULL, false, true);
	DependencyProperty::RegisterFull (this, Type::BITMAPSOURCE, "PixelWidth", true, new Value (0), Type::INT32, false, false, false, NULL, Validators::IntGreaterThanZeroValidator, NULL, false, false);
	DependencyProperty::RegisterFull (this, Type::BITMAPSOURCE, "PixelHeight", true, new Value (0), Type::INT32, false, false, false, NULL, Validators::IntGreaterThanZeroValidator, NULL, false, false);
	DependencyProperty::Register (this, Type::BITMAPSOURCE, "PixelFormat", true, new Value (PixelFormatPbgra32), Type::INT32);
	DependencyProperty::Register (this, Type::BEZIERSEGMENT, "Point3", true, Type::POINT);
	DependencyProperty::Register (this, Type::BEZIERSEGMENT, "Point2", true, Type::POINT);
	DependencyProperty::Register (this, Type::BEZIERSEGMENT, "Point1", true, Type::POINT);
	DependencyProperty::Register (this, Type::BEGINSTORYBOARD, "Storyboard", true, Type::STORYBOARD);
	DependencyProperty::Register (this, Type::ARCSEGMENT, "SweepDirection", true, new Value (SweepDirectionCounterclockwise), Type::INT32);
	DependencyProperty::Register (this, Type::ARCSEGMENT, "Size", true, Type::SIZE);
	DependencyProperty::Register (this, Type::ARCSEGMENT, "RotationAngle", true, new Value (0.0), Type::DOUBLE);
	DependencyProperty::Register (this, Type::ARCSEGMENT, "Point", true, Type::POINT);
	DependencyProperty::Register (this, Type::ARCSEGMENT, "IsLargeArc", true, new Value (false), Type::BOOL);
}
