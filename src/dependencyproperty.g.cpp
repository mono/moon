...
{
	Application::ResourcesProperty = DependencyProperty::RegisterFull (Type::APPLICATION, "Resources", NULL, Type::RESOURCE_DICTIONARY, true, false, false, false, NULL, NULL);
	...
	Border::BorderThicknessProperty = DependencyProperty::RegisterFull (Type::BORDER, "BorderThickness", new Value (Thickness(0)), Type::THICKNESS, false, false, false, false, NULL, Validators::BorderThicknessValidator);
	Border::ChildProperty = DependencyProperty::Register (Type::BORDER, "Child", Type::UIELEMENT);
	Border::CornerRadiusProperty = DependencyProperty::RegisterFull (Type::BORDER, "CornerRadius", NULL, Type::CORNERRADIUS, false, false, false, false, NULL, Validators::CornerRadiusValidator);
	Border::PaddingProperty = DependencyProperty::RegisterFull (Type::BORDER, "Padding", new Value (Thickness(0)), Type::THICKNESS, false, false, false, false, NULL, Validators::BorderThicknessValidator);
	...
	Canvas::LeftProperty = DependencyProperty::RegisterFull (Type::CANVAS, "Left", new Value (0.0), Type::DOUBLE, false, true, false, false, NULL, NULL);
	Canvas::TopProperty = DependencyProperty::RegisterFull (Type::CANVAS, "Top", new Value (0.0), Type::DOUBLE, false, true, false, false, NULL, NULL);
	Canvas::ZIndexProperty = DependencyProperty::RegisterFull (Type::CANVAS, "ZIndex", new Value (0), Type::INT32, false, true, false, false, NULL, NULL);
	...
	ColorAnimationUsingKeyFrames::KeyFramesProperty = DependencyProperty::RegisterFull (Type::COLORANIMATIONUSINGKEYFRAMES, "KeyFrames", NULL, Type::COLORKEYFRAME_COLLECTION, true, false, false, false, NULL, NULL);
	...
	Control::TemplateProperty = DependencyProperty::RegisterFull (Type::CONTROL, "Template", NULL, Type::CONTROLTEMPLATE, false, false, false, false, NULL, Validators::TemplateValidator);
	...
	DoubleAnimationUsingKeyFrames::KeyFramesProperty = DependencyProperty::RegisterFull (Type::DOUBLEANIMATIONUSINGKEYFRAMES, "KeyFrames", NULL, Type::DOUBLEKEYFRAME_COLLECTION, true, false, false, false, NULL, NULL);
	...
	EventTrigger::ActionsProperty = DependencyProperty::RegisterFull (Type::EVENTTRIGGER, "Actions", NULL, Type::TRIGGERACTION_COLLECTION, true, false, false, false, NULL, NULL);
	...
	FrameworkElement::LanguageProperty = DependencyProperty::RegisterFull (Type::FRAMEWORKELEMENT, "Language", new Value ("en-US"), Type::STRING, false, false, false, false, NULL, Validators::NonNullStringValidator);
	...
	FrameworkElement::StyleProperty = DependencyProperty::RegisterFull (Type::FRAMEWORKELEMENT, "Style", NULL, Type::STYLE, false, false, false, false, NULL, Validators::StyleValidator);
	...
	GeometryGroup::ChildrenProperty = DependencyProperty::RegisterFull (Type::GEOMETRYGROUP, "Children", NULL, Type::GEOMETRY_COLLECTION, true, false, false, false, NULL, NULL);
	...
	Glyphs::FontUriProperty = DependencyProperty::RegisterFull (Type::GLYPHS, "FontUri", NULL, Type::STRING, false, false, false, false, NULL, Validators::NonNullStringValidator);
	...
	GradientBrush::GradientStopsProperty = DependencyProperty::RegisterFull (Type::GRADIENTBRUSH, "GradientStops", NULL, Type::GRADIENTSTOP_COLLECTION, true, false, false, false, NULL, NULL);
	...
	Grid::ColumnDefinitionsProperty = DependencyProperty::RegisterFull (Type::GRID, "ColumnDefinitions", NULL, Type::COLUMNDEFINITION_COLLECTION, true, false, false, false, NULL, NULL);
	Grid::ColumnProperty = DependencyProperty::RegisterFull (Type::GRID, "Column", new Value (0), Type::INT32, false, true, false, false, NULL, Validators::PositiveIntValidator);
	Grid::ColumnSpanProperty = DependencyProperty::RegisterFull (Type::GRID, "ColumnSpan", new Value (1), Type::INT32, false, true, false, false, NULL, Validators::IntGreaterThanZeroValidator);
	Grid::RowDefinitionsProperty = DependencyProperty::RegisterFull (Type::GRID, "RowDefinitions", NULL, Type::ROWDEFINITION_COLLECTION, true, false, false, false, NULL, NULL);
	Grid::RowProperty = DependencyProperty::RegisterFull (Type::GRID, "Row", new Value (0), Type::INT32, false, true, false, false, NULL, Validators::PositiveIntValidator);
	Grid::RowSpanProperty = DependencyProperty::RegisterFull (Type::GRID, "RowSpan", new Value (1), Type::INT32, false, true, false, false, NULL, Validators::IntGreaterThanZeroValidator);
	...
	InkPresenter::StrokesProperty = DependencyProperty::RegisterFull (Type::INKPRESENTER, "Strokes", NULL, Type::STROKE_COLLECTION, true, false, false, false, NULL, NULL);
	...
	Inline::LanguageProperty = DependencyProperty::RegisterFull (Type::INLINE, "Language", new Value ("en-US"), Type::STRING, false, false, false, false, NULL, Validators::NonNullStringValidator);
	...
	InputMethod::IsInputMethodEnabledProperty = DependencyProperty::RegisterFull (Type::INPUTMETHOD, "IsInputMethodEnabled", NULL, Type::BOOL, false, true, false, false, NULL, NULL);
	...
	LayoutInformation::LastArrangeProperty = DependencyProperty::RegisterFull (Type::LAYOUTINFORMATION, "LastArrange", NULL, Type::SIZE, false, true, false, false, NULL, NULL);
	LayoutInformation::LastMeasureProperty = DependencyProperty::RegisterFull (Type::LAYOUTINFORMATION, "LastMeasure", NULL, Type::SIZE, false, true, false, false, NULL, NULL);
	LayoutInformation::LayoutClipProperty = DependencyProperty::RegisterFull (Type::LAYOUTINFORMATION, "LayoutClip", NULL, Type::GEOMETRY, false, true, false, false, NULL, NULL);
	LayoutInformation::LayoutSlotProperty = DependencyProperty::RegisterFull (Type::LAYOUTINFORMATION, "LayoutSlot", NULL, Type::RECT, false, true, false, false, NULL, NULL);
	...
	MediaBase::SourceProperty = DependencyProperty::RegisterFull (Type::MEDIABASE, "Source", NULL, Type::STRING, false, false, false, true, NULL, NULL);
	MediaBase::StretchProperty = DependencyProperty::Register (Type::MEDIABASE, "Stretch", new Value (StretchUniform), Type::INT32);
	MediaElement::AttributesProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "Attributes", NULL, Type::MEDIAATTRIBUTE_COLLECTION, true, false, false, false, NULL, Validators::MediaAttributeCollectionValidator);
	MediaElement::AudioStreamCountProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "AudioStreamCount", new Value (0), Type::INT32, false, false, true, false, NULL, NULL);
	...
	MediaElement::BufferingProgressProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "BufferingProgress", new Value (0.0), Type::DOUBLE, false, false, true, false, NULL, NULL);
	MediaElement::BufferingTimeProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "BufferingTime", new Value (TimeSpan_FromSeconds (5),Type::TIMESPAN), Type::TIMESPAN, false, false, false, false, NULL, Validators::BufferingTimeValidator);
	MediaElement::CanPauseProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "CanPause", new Value (false), Type::BOOL, false, false, true, false, NULL, NULL);
	MediaElement::CanSeekProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "CanSeek", new Value (false), Type::BOOL, false, false, true, false, NULL, NULL);
	MediaElement::CurrentStateProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "CurrentState", NULL, Type::INT32, false, false, true, false, NULL, NULL);
	MediaElement::DownloadProgressOffsetProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "DownloadProgressOffset", new Value (0.0), Type::DOUBLE, false, false, true, false, NULL, NULL);
	...
	MediaElement::DroppedFramesPerSecondProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "DroppedFramesPerSecond", new Value (0.0), Type::DOUBLE, false, false, true, false, NULL, NULL);
	MediaElement::IsMutedProperty = DependencyProperty::Register (Type::MEDIAELEMENT, "IsMuted", new Value (false), Type::BOOL);
	MediaElement::MarkersProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "Markers", NULL, Type::TIMELINEMARKER_COLLECTION, true, false, false, false, NULL, NULL);
	MediaElement::NaturalDurationProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "NaturalDuration", new Value (Duration::FromSeconds (0)), Type::DURATION, false, false, true, false, NULL, NULL);
	MediaElement::NaturalVideoHeightProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "NaturalVideoHeight", new Value (0.0), Type::DOUBLE, false, false, true, false, NULL, Validators::DoubleGreaterThanZeroValidator);
	MediaElement::NaturalVideoWidthProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "NaturalVideoWidth", new Value (0.0), Type::DOUBLE, false, false, true, false, NULL, Validators::DoubleGreaterThanZeroValidator);
	MediaElement::PositionProperty = DependencyProperty::Register (Type::MEDIAELEMENT, "Position", Type::TIMESPAN);
	MediaElement::RenderedFramesPerSecondProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "RenderedFramesPerSecond", new Value (0.0), Type::DOUBLE, false, false, true, false, NULL, NULL);
	MediaElement::SourceProperty = DependencyProperty::RegisterFull (Type::MEDIAELEMENT, "Source", NULL, Type::STRING, false, false, false, true, NULL, NULL);
	...
	MultiScaleSubImage::AspectRatioProperty = DependencyProperty::RegisterFull (Type::MULTISCALESUBIMAGE, "AspectRatio", new Value (1.0), Type::DOUBLE, false, false, true, false, NULL, NULL);
	...
	NameScope::NameScopeProperty = DependencyProperty::RegisterFull (Type::NAMESCOPE, "NameScope", NULL, Type::NAMESCOPE, false, true, false, false, NULL, NULL);
	...
	Panel::ChildrenProperty = DependencyProperty::RegisterFull (Type::PANEL, "Children", NULL, Type::UIELEMENT_COLLECTION, true, false, false, false, NULL, NULL);
	PasswordBox::MaxLengthProperty = DependencyProperty::RegisterFull (Type::PASSWORDBOX, "MaxLength", new Value (0), Type::INT32, false, false, false, false, NULL, Validators::IntGreaterThanZeroValidator);
	PasswordBox::PasswordCharProperty = DependencyProperty::Register (Type::PASSWORDBOX, "PasswordChar", new Value (9679), Type::CHAR);
	PasswordBox::PasswordProperty = DependencyProperty::RegisterFull (Type::PASSWORDBOX, "Password", new Value (""), Type::STRING, false, false, false, false, NULL, Validators::PasswordValidator);
	...
	PathFigure::SegmentsProperty = DependencyProperty::RegisterFull (Type::PATHFIGURE, "Segments", NULL, Type::PATHSEGMENT_COLLECTION, true, false, false, false, NULL, NULL);
	...
	PointAnimationUsingKeyFrames::KeyFramesProperty = DependencyProperty::RegisterFull (Type::POINTANIMATIONUSINGKEYFRAMES, "KeyFrames", NULL, Type::POINTKEYFRAME_COLLECTION, true, false, false, false, NULL, NULL);
	...
	Setter::PropertyProperty = DependencyProperty::RegisterFull (Type::SETTER, "Property", NULL, Type::DEPENDENCYPROPERTY, false, false, false, false, NULL, Validators::IsSetterSealedValidator);
	Setter::ValueProperty = DependencyProperty::RegisterFull (Type::SETTER, "Value", NULL, Type::OBJECT, false, false, false, false, NULL, Validators::IsSetterSealedValidator);
	...
	SplineColorKeyFrame::KeySplineProperty = DependencyProperty::RegisterFull (Type::SPLINECOLORKEYFRAME, "KeySpline", NULL, Type::KEYSPLINE, true, false, false, false, NULL, NULL);
	SplineDoubleKeyFrame::KeySplineProperty = DependencyProperty::RegisterFull (Type::SPLINEDOUBLEKEYFRAME, "KeySpline", NULL, Type::KEYSPLINE, true, false, false, false, NULL, NULL);
	SplinePointKeyFrame::KeySplineProperty = DependencyProperty::RegisterFull (Type::SPLINEPOINTKEYFRAME, "KeySpline", NULL, Type::KEYSPLINE, true, false, false, false, NULL, NULL);
	Storyboard::TargetNameProperty = DependencyProperty::RegisterFull (Type::STORYBOARD, "TargetName", NULL, Type::STRING, false, true, false, false, NULL, Validators::IsTimelineValidator);
	Storyboard::TargetPropertyProperty = DependencyProperty::RegisterFull (Type::STORYBOARD, "TargetProperty", NULL, Type::PROPERTYPATH, false, true, false, false, NULL, Validators::IsTimelineValidator);
	Stroke::DrawingAttributesProperty = DependencyProperty::RegisterFull (Type::STROKE, "DrawingAttributes", NULL, Type::DRAWINGATTRIBUTES, true, false, false, false, NULL, NULL);
	Stroke::StylusPointsProperty = DependencyProperty::RegisterFull (Type::STROKE, "StylusPoints", NULL, Type::STYLUSPOINT_COLLECTION, true, false, false, false, NULL, NULL);
	Style::IsSealedProperty = DependencyProperty::Register (Type::STYLE, "IsSealed", new Value (false), Type::BOOL);
	Style::SettersProperty = DependencyProperty::RegisterFull (Type::STYLE, "Setters", NULL, Type::SETTERBASE_COLLECTION, true, false, false, false, NULL, NULL);
	...
	TextBlock::InlinesProperty = DependencyProperty::RegisterFull (Type::TEXTBLOCK, "Inlines", NULL, Type::INLINE_COLLECTION, true, false, false, false, NULL, NULL);
	...
	TextBox::MaxLengthProperty = DependencyProperty::RegisterFull (Type::TEXTBOX, "MaxLength", new Value (0), Type::INT32, false, false, false, false, NULL, Validators::PositiveIntValidator);
	...
	TextBox::SelectionLengthProperty = DependencyProperty::RegisterFull (Type::TEXTBOX, "SelectionLength", new Value (0), Type::INT32, false, false, false, false, NULL, Validators::PositiveIntValidator);
	TextBox::SelectionStartProperty = DependencyProperty::RegisterFull (Type::TEXTBOX, "SelectionStart", new Value (0), Type::INT32, false, false, false, false, NULL, Validators::PositiveIntValidator);
	...
	TimelineGroup::ChildrenProperty = DependencyProperty::RegisterFull (Type::TIMELINEGROUP, "Children", NULL, Type::TIMELINE_COLLECTION, true, false, false, false, NULL, NULL);
	...
	TransformGroup::ChildrenProperty = DependencyProperty::RegisterFull (Type::TRANSFORMGROUP, "Children", NULL, Type::TRANSFORM_COLLECTION, true, false, false, false, NULL, NULL);
	...
	UIElement::CursorProperty = DependencyProperty::RegisterFull (Type::UIELEMENT, "Cursor", new Value (MouseCursorDefault), Type::INT32, false, false, false, false, NULL, Validators::CursorValidator);
	...
	UIElement::ResourcesProperty = DependencyProperty::RegisterFull (Type::UIELEMENT, "Resources", NULL, Type::RESOURCE_DICTIONARY, true, false, false, false, NULL, NULL);
	UIElement::TagProperty = DependencyProperty::Register (Type::UIELEMENT, "Tag", Type::STRING);
	UIElement::TriggersProperty = DependencyProperty::RegisterFull (Type::UIELEMENT, "Triggers", NULL, Type::TRIGGER_COLLECTION, true, false, false, false, NULL, NULL);
