...
const int PasswordBox::PasswordProperty = 0;
const int PasswordBox::PasswordCharProperty = 1;
const int PasswordBox::MaxLengthProperty = 2;
const int InkPresenter::StrokesProperty = 3;
const int VisualBrush::VisualProperty = 4;
const int VideoBrush::SourceNameProperty = 5;
const int ImageBrush::ImageSourceProperty = 6;
const int ImageBrush::DownloadProgressProperty = 7;
const int RadialGradientBrush::RadiusYProperty = 8;
const int RadialGradientBrush::RadiusXProperty = 9;
const int RadialGradientBrush::GradientOriginProperty = 10;
const int RadialGradientBrush::CenterProperty = 11;
const int LinearGradientBrush::StartPointProperty = 12;
const int LinearGradientBrush::EndPointProperty = 13;
const int Rectangle::RadiusYProperty = 14;
const int Rectangle::RadiusXProperty = 15;
const int Polyline::PointsProperty = 16;
const int Polyline::FillRuleProperty = 17;
const int Polygon::PointsProperty = 18;
const int Polygon::FillRuleProperty = 19;
const int Path::DataProperty = 20;
const int Line::Y2Property = 21;
const int Line::Y1Property = 22;
const int Line::X2Property = 23;
const int Line::X1Property = 24;
const int MultiScaleImage::ViewportWidthProperty = 25;
const int MultiScaleImage::ViewportOriginProperty = 26;
const int MultiScaleImage::UseSpringsProperty = 27;
const int MultiScaleImage::SubImagesProperty = 28;
const int MultiScaleImage::SourceProperty = 29;
const int MultiScaleImage::AspectRatioProperty = 30;
const int Image::SourceProperty = 31;
const int UserControl::ContentProperty = 32;
const int TextBox::VerticalScrollBarVisibilityProperty = 33;
const int TextBox::TextWrappingProperty = 34;
const int TextBox::TextProperty = 35;
const int TextBox::TextAlignmentProperty = 36;
const int TextBox::SelectionStartProperty = 37;
const int TextBox::SelectionLengthProperty = 38;
const int TextBox::SelectionForegroundProperty = 39;
const int TextBox::SelectionBackgroundProperty = 40;
const int TextBox::SelectedTextProperty = 41;
const int TextBox::MaxLengthProperty = 42;
const int TextBox::IsReadOnlyProperty = 43;
const int TextBox::HorizontalScrollBarVisibilityProperty = 44;
const int TextBox::AcceptsReturnProperty = 45;
const int ContentControl::ContentTemplateProperty = 46;
const int ContentControl::ContentProperty = 47;
const int Grid::ShowGridLinesProperty = 48;
const int Grid::RowSpanProperty = 49;
const int Grid::RowProperty = 50;
const int Grid::RowDefinitionsProperty = 51;
const int Grid::ColumnSpanProperty = 52;
const int Grid::ColumnProperty = 53;
const int Grid::ColumnDefinitionsProperty = 54;
const int Canvas::ZIndexProperty = 55;
const int Canvas::TopProperty = 56;
const int Canvas::LeftProperty = 57;
const int SolidColorBrush::ColorProperty = 58;
const int TileBrush::StretchProperty = 59;
const int TileBrush::AlignmentYProperty = 60;
const int TileBrush::AlignmentXProperty = 61;
const int GradientBrush::SpreadMethodProperty = 62;
const int GradientBrush::MappingModeProperty = 63;
const int GradientBrush::GradientStopsProperty = 64;
const int GradientBrush::ColorInterpolationModeProperty = 65;
const int TextBlock::TextWrappingProperty = 66;
const int TextBlock::TextProperty = 67;
const int TextBlock::TextDecorationsProperty = 68;
const int TextBlock::TextAlignmentProperty = 69;
const int TextBlock::PaddingProperty = 70;
const int TextBlock::LineStackingStrategyProperty = 71;
const int TextBlock::LineHeightProperty = 72;
const int TextBlock::InlinesProperty = 73;
const int TextBlock::ForegroundProperty = 74;
const int TextBlock::FontWeightProperty = 75;
const int TextBlock::FontStyleProperty = 76;
const int TextBlock::FontStretchProperty = 77;
const int TextBlock::FontSizeProperty = 78;
const int TextBlock::FontFilenameProperty = 79;
const int TextBlock::FontFamilyProperty = 80;
const int Popup::VerticalOffsetProperty = 81;
const int Popup::IsOpenProperty = 82;
const int Popup::HorizontalOffsetProperty = 83;
const int Popup::ChildProperty = 84;
const int MediaElement::VolumeProperty = 85;
const int MediaElement::StretchProperty = 86;
const int MediaElement::SourceProperty = 87;
const int MediaElement::RenderedFramesPerSecondProperty = 88;
const int MediaElement::PositionProperty = 89;
const int MediaElement::NaturalVideoWidthProperty = 90;
const int MediaElement::NaturalVideoHeightProperty = 91;
const int MediaElement::NaturalDurationProperty = 92;
const int MediaElement::MarkersProperty = 93;
const int MediaElement::IsMutedProperty = 94;
const int MediaElement::DroppedFramesPerSecondProperty = 95;
const int MediaElement::DownloadProgressProperty = 96;
const int MediaElement::DownloadProgressOffsetProperty = 97;
const int MediaElement::CurrentStateProperty = 98;
const int MediaElement::CanSeekProperty = 99;
const int MediaElement::CanPauseProperty = 100;
const int MediaElement::BufferingTimeProperty = 101;
const int MediaElement::BufferingProgressProperty = 102;
const int MediaElement::BalanceProperty = 103;
const int MediaElement::AutoPlayProperty = 104;
const int MediaElement::AudioStreamIndexProperty = 105;
const int MediaElement::AudioStreamCountProperty = 106;
const int MediaElement::AttributesProperty = 107;
const int Shape::StrokeThicknessProperty = 108;
const int Shape::StrokeStartLineCapProperty = 109;
const int Shape::StrokeProperty = 110;
const int Shape::StrokeMiterLimitProperty = 111;
const int Shape::StrokeLineJoinProperty = 112;
const int Shape::StrokeEndLineCapProperty = 113;
const int Shape::StrokeDashOffsetProperty = 114;
const int Shape::StrokeDashCapProperty = 115;
const int Shape::StrokeDashArrayProperty = 116;
const int Shape::StretchProperty = 117;
const int Shape::FillProperty = 118;
const int MediaBase::StretchProperty = 119;
const int MediaBase::SourceProperty = 120;
const int MediaBase::DownloadProgressProperty = 121;
const int Glyphs::UnicodeStringProperty = 122;
const int Glyphs::StyleSimulationsProperty = 123;
const int Glyphs::OriginYProperty = 124;
const int Glyphs::OriginXProperty = 125;
const int Glyphs::IndicesProperty = 126;
const int Glyphs::FontUriProperty = 127;
const int Glyphs::FontRenderingEmSizeProperty = 128;
const int Glyphs::FillProperty = 129;
const int Control::VerticalContentAlignmentProperty = 130;
const int Control::TemplateProperty = 131;
const int Control::TabNavigationProperty = 132;
const int Control::TabIndexProperty = 133;
const int Control::PaddingProperty = 134;
const int Control::IsTabStopProperty = 135;
const int Control::HorizontalContentAlignmentProperty = 136;
const int Control::ForegroundProperty = 137;
const int Control::FontWeightProperty = 138;
const int Control::FontStyleProperty = 139;
const int Control::FontStretchProperty = 140;
const int Control::FontSizeProperty = 141;
const int Control::FontFamilyProperty = 142;
const int Control::DefaultStyleKeyProperty = 143;
const int Control::BorderThicknessProperty = 144;
const int Control::BorderBrushProperty = 145;
const int Control::BackgroundProperty = 146;
const int Panel::ChildrenProperty = 147;
const int Panel::BackgroundProperty = 148;
const int Border::PaddingProperty = 149;
const int Border::CornerRadiusProperty = 150;
const int Border::ChildProperty = 151;
const int Border::BorderThicknessProperty = 152;
const int Border::BorderBrushProperty = 153;
const int Border::BackgroundProperty = 154;
const int TimelineGroup::ChildrenProperty = 155;
const int Setter::ValueProperty = 156;
const int Setter::PropertyProperty = 157;
const int Setter::ConvertedValueProperty = 158;
const int Run::TextProperty = 159;
const int Brush::TransformProperty = 160;
const int Brush::RelativeTransformProperty = 161;
const int Brush::OpacityProperty = 162;
const int Brush::ChangedProperty = 163;
const int RectangleGeometry::RectProperty = 164;
const int RectangleGeometry::RadiusYProperty = 165;
const int RectangleGeometry::RadiusXProperty = 166;
const int PathGeometry::FillRuleProperty = 167;
const int PathGeometry::FiguresProperty = 168;
const int LineGeometry::StartPointProperty = 169;
const int LineGeometry::EndPointProperty = 170;
const int GeometryGroup::FillRuleProperty = 171;
const int GeometryGroup::ChildrenProperty = 172;
const int EllipseGeometry::RadiusYProperty = 173;
const int EllipseGeometry::RadiusXProperty = 174;
const int EllipseGeometry::CenterProperty = 175;
const int FrameworkElement::WidthProperty = 176;
const int FrameworkElement::VerticalAlignmentProperty = 177;
const int FrameworkElement::StyleProperty = 178;
const int FrameworkElement::MinWidthProperty = 179;
const int FrameworkElement::MinHeightProperty = 180;
const int FrameworkElement::MaxWidthProperty = 181;
const int FrameworkElement::MaxHeightProperty = 182;
const int FrameworkElement::MarginProperty = 183;
const int FrameworkElement::LanguageProperty = 184;
const int FrameworkElement::HorizontalAlignmentProperty = 185;
const int FrameworkElement::HeightProperty = 186;
const int FrameworkElement::DataContextProperty = 187;
const int FrameworkElement::ActualWidthProperty = 188;
const int FrameworkElement::ActualHeightProperty = 189;
const int SplinePointKeyFrame::KeySplineProperty = 190;
const int PointAnimationUsingKeyFrames::KeyFramesProperty = 191;
const int SplineDoubleKeyFrame::KeySplineProperty = 192;
...
const int Inline::FontSizeProperty = 243;
const int Inline::FontFilenameProperty = 244;
const int Inline::FontFamilyProperty = 245;
const int GradientStop::OffsetProperty = 246;
const int GradientStop::ColorProperty = 247;
const int Geometry::TransformProperty = 248;
const int DrawingAttributes::WidthProperty = 249;
const int DrawingAttributes::OutlineColorProperty = 250;
const int DrawingAttributes::HeightProperty = 251;
const int DrawingAttributes::ColorProperty = 252;
const int Downloader::UriProperty = 253;
const int Downloader::StatusTextProperty = 254;
const int Downloader::StatusProperty = 255;
const int Downloader::ResponseTextProperty = 256;
const int Downloader::DownloadProgressProperty = 257;
const int Deployment::SurfaceProperty = 258;
const int Deployment::RuntimeVersionProperty = 259;
const int Deployment::PartsProperty = 260;
const int Deployment::ExternalCallersFromCrossDomainProperty = 261;
const int Deployment::EntryPointTypeProperty = 262;
const int Deployment::EntryPointAssemblyProperty = 263;
const int ColumnDefinition::WidthProperty = 264;
const int ColumnDefinition::MinWidthProperty = 265;
const int ColumnDefinition::MaxWidthProperty = 266;
const int Collection::CountProperty = 267;
const int UIElement::VisibilityProperty = 268;
const int UIElement::UseLayoutRoundingProperty = 269;
const int UIElement::TriggersProperty = 270;
const int UIElement::TagProperty = 271;
const int UIElement::ResourcesProperty = 272;
const int UIElement::RenderTransformProperty = 273;
const int UIElement::RenderTransformOriginProperty = 274;
const int UIElement::OpacityProperty = 275;
const int UIElement::OpacityMaskProperty = 276;
const int UIElement::IsHitTestVisibleProperty = 277;
const int UIElement::CursorProperty = 278;
const int UIElement::ClipProperty = 279;
const int AssemblyPart::SourceProperty = 280;
const int Application::ResourcesProperty = 281;
const int SplineColorKeyFrame::KeySplineProperty = 282;
const int ColorAnimationUsingKeyFrames::KeyFramesProperty = 283;
const int TranslateTransform::YProperty = 284;
const int TranslateTransform::XProperty = 285;
const int TransformGroup::ChildrenProperty = 286;
...
const int ObjectKeyFrame::ValueProperty = 311;
const int ObjectKeyFrame::KeyTimeProperty = 312;
const int ObjectAnimationUsingKeyFrames::KeyFramesProperty = 313;
const int MatrixTransform::MatrixProperty = 314;
const int LineSegment::PointProperty = 315;
const int LayoutInformation::LayoutSlotProperty = 316;
const int LayoutInformation::LayoutClipProperty = 317;
const int LayoutInformation::LastMeasureProperty = 318;
const int LayoutInformation::LastArrangeProperty = 319;
const int EventTrigger::RoutedEventProperty = 320;
const int EventTrigger::ActionsProperty = 321;
const int DoubleKeyFrame::ValueProperty = 322;
const int DoubleKeyFrame::KeyTimeProperty = 323;
const int DoubleAnimation::ToProperty = 324;
const int DoubleAnimation::FromProperty = 325;
const int DoubleAnimation::ByProperty = 326;
const int DependencyObject::NameProperty = 327;
const int DeepZoomImageTileSource::UriSourceProperty = 328;
const int ControlTemplate::TargetTypeProperty = 329;
const int ColorKeyFrame::ValueProperty = 330;
const int ColorKeyFrame::KeyTimeProperty = 331;
const int ColorAnimation::ToProperty = 332;
const int ColorAnimation::FromProperty = 333;
const int ColorAnimation::ByProperty = 334;
const int BitmapImage::UriSourceProperty = 335;
const int BezierSegment::Point3Property = 336;
const int BezierSegment::Point2Property = 337;
const int BezierSegment::Point1Property = 338;
const int BeginStoryboard::StoryboardProperty = 339;
const int ArcSegment::SweepDirectionProperty = 340;
const int ArcSegment::SizeProperty = 341;
const int ArcSegment::RotationAngleProperty = 342;
const int ArcSegment::PointProperty = 343;
const int ArcSegment::IsLargeArcProperty = 344;
