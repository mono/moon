...
const int MultiScaleImage::SubImagesProperty = 26;
const int MultiScaleImage::SourceProperty = 27;
const int MultiScaleImage::AspectRatioProperty = 28;
const int Image::SourceProperty = 29;
const int UserControl::ContentProperty = 30;
const int TextBox::VerticalScrollBarVisibilityProperty = 31;
const int TextBox::TextWrappingProperty = 32;
const int TextBox::TextProperty = 33;
const int TextBox::TextAlignmentProperty = 34;
const int TextBox::SelectionStartProperty = 35;
const int TextBox::SelectionLengthProperty = 36;
const int TextBox::SelectionForegroundProperty = 37;
const int TextBox::SelectionBackgroundProperty = 38;
const int TextBox::SelectedTextProperty = 39;
const int TextBox::MaxLengthProperty = 40;
const int TextBox::IsReadOnlyProperty = 41;
const int TextBox::HorizontalScrollBarVisibilityProperty = 42;
const int TextBox::AcceptsReturnProperty = 43;
const int ContentControl::ContentTemplateProperty = 44;
const int ContentControl::ContentProperty = 45;
const int Grid::ShowGridLinesProperty = 46;
const int Grid::RowSpanProperty = 47;
const int Grid::RowProperty = 48;
const int Grid::RowDefinitionsProperty = 49;
const int Grid::ColumnSpanProperty = 50;
const int Grid::ColumnProperty = 51;
const int Grid::ColumnDefinitionsProperty = 52;
const int Canvas::ZIndexProperty = 53;
const int Canvas::TopProperty = 54;
const int Canvas::LeftProperty = 55;
const int SolidColorBrush::ColorProperty = 56;
const int TileBrush::StretchProperty = 57;
const int TileBrush::AlignmentYProperty = 58;
const int TileBrush::AlignmentXProperty = 59;
const int GradientBrush::SpreadMethodProperty = 60;
const int GradientBrush::MappingModeProperty = 61;
const int GradientBrush::GradientStopsProperty = 62;
const int GradientBrush::ColorInterpolationModeProperty = 63;
const int TextBlock::TextWrappingProperty = 64;
const int TextBlock::TextProperty = 65;
const int TextBlock::TextDecorationsProperty = 66;
const int TextBlock::TextAlignmentProperty = 67;
const int TextBlock::PaddingProperty = 68;
const int TextBlock::LineStackingStrategyProperty = 69;
const int TextBlock::LineHeightProperty = 70;
const int TextBlock::InlinesProperty = 71;
const int TextBlock::ForegroundProperty = 72;
const int TextBlock::FontWeightProperty = 73;
const int TextBlock::FontStyleProperty = 74;
const int TextBlock::FontStretchProperty = 75;
const int TextBlock::FontSizeProperty = 76;
const int TextBlock::FontFilenameProperty = 77;
const int TextBlock::FontFamilyProperty = 78;
const int Popup::VerticalOffsetProperty = 79;
const int Popup::IsOpenProperty = 80;
const int Popup::HorizontalOffsetProperty = 81;
const int Popup::ChildProperty = 82;
const int MediaElement::VolumeProperty = 83;
const int MediaElement::StretchProperty = 84;
const int MediaElement::SourceProperty = 85;
const int MediaElement::RenderedFramesPerSecondProperty = 86;
const int MediaElement::PositionProperty = 87;
const int MediaElement::NaturalVideoWidthProperty = 88;
const int MediaElement::NaturalVideoHeightProperty = 89;
const int MediaElement::NaturalDurationProperty = 90;
const int MediaElement::MarkersProperty = 91;
const int MediaElement::IsMutedProperty = 92;
const int MediaElement::DroppedFramesPerSecondProperty = 93;
const int MediaElement::DownloadProgressProperty = 94;
const int MediaElement::DownloadProgressOffsetProperty = 95;
const int MediaElement::CurrentStateProperty = 96;
const int MediaElement::CanSeekProperty = 97;
const int MediaElement::CanPauseProperty = 98;
const int MediaElement::BufferingTimeProperty = 99;
const int MediaElement::BufferingProgressProperty = 100;
const int MediaElement::BalanceProperty = 101;
const int MediaElement::AutoPlayProperty = 102;
const int MediaElement::AudioStreamIndexProperty = 103;
const int MediaElement::AudioStreamCountProperty = 104;
const int MediaElement::AttributesProperty = 105;
const int Shape::StrokeThicknessProperty = 106;
const int Shape::StrokeStartLineCapProperty = 107;
const int Shape::StrokeProperty = 108;
const int Shape::StrokeMiterLimitProperty = 109;
const int Shape::StrokeLineJoinProperty = 110;
const int Shape::StrokeEndLineCapProperty = 111;
const int Shape::StrokeDashOffsetProperty = 112;
const int Shape::StrokeDashCapProperty = 113;
const int Shape::StrokeDashArrayProperty = 114;
const int Shape::StretchProperty = 115;
const int Shape::FillProperty = 116;
const int MediaBase::StretchProperty = 117;
const int MediaBase::SourceProperty = 118;
const int MediaBase::DownloadProgressProperty = 119;
const int Glyphs::UnicodeStringProperty = 120;
const int Glyphs::StyleSimulationsProperty = 121;
const int Glyphs::OriginYProperty = 122;
const int Glyphs::OriginXProperty = 123;
const int Glyphs::IndicesProperty = 124;
const int Glyphs::FontUriProperty = 125;
const int Glyphs::FontRenderingEmSizeProperty = 126;
const int Glyphs::FillProperty = 127;
const int Control::VerticalContentAlignmentProperty = 128;
const int Control::TemplateProperty = 129;
const int Control::TabNavigationProperty = 130;
const int Control::TabIndexProperty = 131;
const int Control::PaddingProperty = 132;
const int Control::IsTabStopProperty = 133;
const int Control::HorizontalContentAlignmentProperty = 134;
const int Control::ForegroundProperty = 135;
const int Control::FontWeightProperty = 136;
const int Control::FontStyleProperty = 137;
const int Control::FontStretchProperty = 138;
const int Control::FontSizeProperty = 139;
const int Control::FontFamilyProperty = 140;
const int Control::DefaultStyleKeyProperty = 141;
const int Control::BorderThicknessProperty = 142;
const int Control::BorderBrushProperty = 143;
const int Control::BackgroundProperty = 144;
...
const int Brush::TransformProperty = 158;
const int Brush::RelativeTransformProperty = 159;
const int Brush::OpacityProperty = 160;
const int Brush::ChangedProperty = 161;
const int RectangleGeometry::RectProperty = 162;
const int RectangleGeometry::RadiusYProperty = 163;
const int RectangleGeometry::RadiusXProperty = 164;
const int PathGeometry::FillRuleProperty = 165;
const int PathGeometry::FiguresProperty = 166;
const int LineGeometry::StartPointProperty = 167;
const int LineGeometry::EndPointProperty = 168;
const int GeometryGroup::FillRuleProperty = 169;
const int GeometryGroup::ChildrenProperty = 170;
const int EllipseGeometry::RadiusYProperty = 171;
const int EllipseGeometry::RadiusXProperty = 172;
const int EllipseGeometry::CenterProperty = 173;
const int FrameworkElement::WidthProperty = 174;
const int FrameworkElement::VerticalAlignmentProperty = 175;
const int FrameworkElement::StyleProperty = 176;
const int FrameworkElement::MinWidthProperty = 177;
const int FrameworkElement::MinHeightProperty = 178;
const int FrameworkElement::MaxWidthProperty = 179;
const int FrameworkElement::MaxHeightProperty = 180;
const int FrameworkElement::MarginProperty = 181;
const int FrameworkElement::LanguageProperty = 182;
const int FrameworkElement::HorizontalAlignmentProperty = 183;
const int FrameworkElement::HeightProperty = 184;
const int FrameworkElement::DataContextProperty = 185;
const int FrameworkElement::ActualWidthProperty = 186;
const int FrameworkElement::ActualHeightProperty = 187;
const int SplinePointKeyFrame::KeySplineProperty = 188;
const int PointAnimationUsingKeyFrames::KeyFramesProperty = 189;
const int SplineDoubleKeyFrame::KeySplineProperty = 190;
const int DoubleAnimationUsingKeyFrames::KeyFramesProperty = 191;
const int TimelineMarker::TypeProperty = 192;
const int TimelineMarker::TimeProperty = 193;
const int TimelineMarker::TextProperty = 194;
const int Timeline::SpeedRatioProperty = 195;
const int Timeline::RepeatBehaviorProperty = 196;
const int Timeline::FillBehaviorProperty = 197;
const int Timeline::DurationProperty = 198;
const int Timeline::BeginTimeProperty = 199;
const int Timeline::AutoReverseProperty = 200;
const int StylusPoint::YProperty = 201;
const int StylusPoint::XProperty = 202;
const int StylusPoint::PressureFactorProperty = 203;
const int StylusInfo::IsInvertedProperty = 204;
const int StylusInfo::DeviceTypeProperty = 205;
const int Style::TargetTypeProperty = 206;
const int Style::SettersProperty = 207;
const int Style::IsSealedProperty = 208;
const int Stroke::StylusPointsProperty = 209;
const int Stroke::DrawingAttributesProperty = 210;
const int SetterBase::IsSealedProperty = 211;
const int RowDefinition::MinHeightProperty = 212;
const int RowDefinition::MaxHeightProperty = 213;
const int RowDefinition::HeightProperty = 214;
const int PathFigure::StartPointProperty = 215;
const int PathFigure::SegmentsProperty = 216;
const int PathFigure::IsFilledProperty = 217;
const int PathFigure::IsClosedProperty = 218;
const int NameScope::NameScopeProperty = 219;
const int MultiScaleSubImage::ZIndexProperty = 220;
const int MultiScaleSubImage::ViewportWidthProperty = 221;
const int MultiScaleSubImage::ViewportOriginProperty = 222;
const int MultiScaleSubImage::OpacityProperty = 223;
const int MultiScaleSubImage::AspectRatioProperty = 224;
const int MediaAttribute::ValueProperty = 225;
const int Matrix::OffsetYProperty = 226;
const int Matrix::OffsetXProperty = 227;
const int Matrix::M22Property = 228;
const int Matrix::M21Property = 229;
const int Matrix::M12Property = 230;
const int Matrix::M11Property = 231;
const int KeySpline::ControlPoint2Property = 232;
const int KeySpline::ControlPoint1Property = 233;
const int InputMethod::IsInputMethodEnabledProperty = 234;
const int Inline::TextDecorationsProperty = 235;
const int Inline::LanguageProperty = 236;
const int Inline::ForegroundProperty = 237;
const int Inline::FontWeightProperty = 238;
const int Inline::FontStyleProperty = 239;
const int Inline::FontStretchProperty = 240;
const int Inline::FontSizeProperty = 241;
const int Inline::FontFilenameProperty = 242;
const int Inline::FontFamilyProperty = 243;
const int GradientStop::OffsetProperty = 244;
const int GradientStop::ColorProperty = 245;
const int Geometry::TransformProperty = 246;
const int DrawingAttributes::WidthProperty = 247;
const int DrawingAttributes::OutlineColorProperty = 248;
const int DrawingAttributes::HeightProperty = 249;
const int DrawingAttributes::ColorProperty = 250;
const int Downloader::UriProperty = 251;
const int Downloader::StatusTextProperty = 252;
const int Downloader::StatusProperty = 253;
const int Downloader::ResponseTextProperty = 254;
const int Downloader::DownloadProgressProperty = 255;
const int Deployment::SurfaceProperty = 256;
const int Deployment::RuntimeVersionProperty = 257;
const int Deployment::PartsProperty = 258;
const int Deployment::ExternalCallersFromCrossDomainProperty = 259;
const int Deployment::EntryPointTypeProperty = 260;
const int Deployment::EntryPointAssemblyProperty = 261;
const int ColumnDefinition::WidthProperty = 262;
const int ColumnDefinition::MinWidthProperty = 263;
const int ColumnDefinition::MaxWidthProperty = 264;
const int Collection::CountProperty = 265;
const int UIElement::VisibilityProperty = 266;
const int UIElement::UseLayoutRoundingProperty = 267;
const int UIElement::TriggersProperty = 268;
const int UIElement::TagProperty = 269;
const int UIElement::ResourcesProperty = 270;
const int UIElement::RenderTransformProperty = 271;
const int UIElement::RenderTransformOriginProperty = 272;
const int UIElement::OpacityProperty = 273;
const int UIElement::OpacityMaskProperty = 274;
const int UIElement::IsHitTestVisibleProperty = 275;
const int UIElement::CursorProperty = 276;
const int UIElement::ClipProperty = 277;
const int AssemblyPart::SourceProperty = 278;
const int Application::ResourcesProperty = 279;
const int SplineColorKeyFrame::KeySplineProperty = 280;
const int ColorAnimationUsingKeyFrames::KeyFramesProperty = 281;
const int TranslateTransform::YProperty = 282;
const int TranslateTransform::XProperty = 283;
const int TransformGroup::ChildrenProperty = 284;
...
const int ObjectKeyFrame::ValueProperty = 309;
const int ObjectKeyFrame::KeyTimeProperty = 310;
const int ObjectAnimationUsingKeyFrames::KeyFramesProperty = 311;
const int MatrixTransform::MatrixProperty = 312;
const int LineSegment::PointProperty = 313;
const int LayoutInformation::LayoutSlotProperty = 314;
const int LayoutInformation::LayoutClipProperty = 315;
const int LayoutInformation::LastMeasureProperty = 316;
const int LayoutInformation::LastArrangeProperty = 317;
const int EventTrigger::RoutedEventProperty = 318;
const int EventTrigger::ActionsProperty = 319;
const int DoubleKeyFrame::ValueProperty = 320;
const int DoubleKeyFrame::KeyTimeProperty = 321;
const int DoubleAnimation::ToProperty = 322;
const int DoubleAnimation::FromProperty = 323;
const int DoubleAnimation::ByProperty = 324;
const int DependencyObject::NameProperty = 325;
const int DeepZoomImageTileSource::UriSourceProperty = 326;
const int ControlTemplate::TargetTypeProperty = 327;
const int ColorKeyFrame::ValueProperty = 328;
const int ColorKeyFrame::KeyTimeProperty = 329;
const int ColorAnimation::ToProperty = 330;
const int ColorAnimation::FromProperty = 331;
const int ColorAnimation::ByProperty = 332;
const int BitmapImage::UriSourceProperty = 333;
const int BezierSegment::Point3Property = 334;
const int BezierSegment::Point2Property = 335;
const int BezierSegment::Point1Property = 336;
const int BeginStoryboard::StoryboardProperty = 337;
const int ArcSegment::SweepDirectionProperty = 338;
const int ArcSegment::SizeProperty = 339;
const int ArcSegment::RotationAngleProperty = 340;
const int ArcSegment::PointProperty = 341;
const int ArcSegment::IsLargeArcProperty = 342;
