...
Types::RegisterNativeProperties ()
{
	...
	DependencyProperty::Register (this, Type::TEXTBLOCK, "FontFilename", false, Type::STRING);
	...
	DependencyProperty::Register (this, Type::INLINE, "FontFilename", false, Type::STRING);
	...
	DependencyProperty::RegisterFull (this, Type::PASSWORDBOX, "Password", false, new Value (""), Type::STRING, false, false, false, NULL, Validators::NonNullValidator, NULL, false);
...
const int Control::IsEnabledProperty = 131;
const int Control::HorizontalContentAlignmentProperty = 132;
const int Control::ForegroundProperty = 133;
const int Control::FontWeightProperty = 134;
const int Control::FontStyleProperty = 135;
const int Control::FontStretchProperty = 136;
const int Control::FontSizeProperty = 137;
const int Control::FontFamilyProperty = 138;
const int Control::DefaultStyleKeyProperty = 139;
const int Control::BorderThicknessProperty = 140;
const int Control::BorderBrushProperty = 141;
const int Control::BackgroundProperty = 142;
const int Panel::ChildrenProperty = 143;
const int Panel::BackgroundProperty = 144;
const int Border::PaddingProperty = 145;
const int Border::CornerRadiusProperty = 146;
const int Border::ChildProperty = 147;
const int Border::BorderThicknessProperty = 148;
const int Border::BorderBrushProperty = 149;
const int Border::BackgroundProperty = 150;
const int TimelineGroup::ChildrenProperty = 151;
const int Setter::ValueProperty = 152;
const int Setter::PropertyProperty = 153;
const int Setter::ConvertedValueProperty = 154;
const int Run::TextProperty = 155;
const int RectangleGeometry::RectProperty = 156;
const int RectangleGeometry::RadiusYProperty = 157;
const int RectangleGeometry::RadiusXProperty = 158;
const int PathGeometry::FillRuleProperty = 159;
const int PathGeometry::FiguresProperty = 160;
const int LineGeometry::StartPointProperty = 161;
const int LineGeometry::EndPointProperty = 162;
const int GeometryGroup::FillRuleProperty = 163;
const int GeometryGroup::ChildrenProperty = 164;
const int EllipseGeometry::RadiusYProperty = 165;
const int EllipseGeometry::RadiusXProperty = 166;
const int EllipseGeometry::CenterProperty = 167;
const int FrameworkElement::WidthProperty = 168;
const int FrameworkElement::VerticalAlignmentProperty = 169;
const int FrameworkElement::StyleProperty = 170;
const int FrameworkElement::MinWidthProperty = 171;
const int FrameworkElement::MinHeightProperty = 172;
const int FrameworkElement::MaxWidthProperty = 173;
const int FrameworkElement::MaxHeightProperty = 174;
const int FrameworkElement::MarginProperty = 175;
const int FrameworkElement::LanguageProperty = 176;
const int FrameworkElement::HorizontalAlignmentProperty = 177;
const int FrameworkElement::HeightProperty = 178;
const int FrameworkElement::DataContextProperty = 179;
const int FrameworkElement::ActualWidthProperty = 180;
const int FrameworkElement::ActualHeightProperty = 181;
const int PowerEase::PowerProperty = 182;
const int ExponentialEase::ExponentProperty = 183;
const int ElasticEase::SpringinessProperty = 184;
const int ElasticEase::OscillationsProperty = 185;
const int BounceEase::BouncinessProperty = 186;
const int BounceEase::BouncesProperty = 187;
const int BackEase::AmplitudeProperty = 188;
const int SplinePointKeyFrame::KeySplineProperty = 189;
const int EasingPointKeyFrame::EasingFunctionProperty = 190;
const int PointAnimationUsingKeyFrames::KeyFramesProperty = 191;
const int SplineDoubleKeyFrame::KeySplineProperty = 192;
const int EasingDoubleKeyFrame::EasingFunctionProperty = 193;
const int DoubleAnimationUsingKeyFrames::KeyFramesProperty = 194;
const int TimelineMarker::TypeProperty = 195;
const int TimelineMarker::TimeProperty = 196;
const int TimelineMarker::TextProperty = 197;
const int Timeline::SpeedRatioProperty = 198;
const int Timeline::RepeatBehaviorProperty = 199;
const int Timeline::FillBehaviorProperty = 200;
const int Timeline::DurationProperty = 201;
const int Timeline::BeginTimeProperty = 202;
const int Timeline::AutoReverseProperty = 203;
const int StylusPoint::YProperty = 204;
const int StylusPoint::XProperty = 205;
const int StylusPoint::PressureFactorProperty = 206;
const int StylusInfo::IsInvertedProperty = 207;
const int StylusInfo::DeviceTypeProperty = 208;
const int Style::TargetTypeProperty = 209;
const int Style::SettersProperty = 210;
const int Style::IsSealedProperty = 211;
const int Stroke::StylusPointsProperty = 212;
const int Stroke::DrawingAttributesProperty = 213;
const int SetterBase::IsSealedProperty = 214;
const int RowDefinition::MinHeightProperty = 215;
const int RowDefinition::MaxHeightProperty = 216;
const int RowDefinition::HeightProperty = 217;
const int PathFigure::StartPointProperty = 218;
const int PathFigure::SegmentsProperty = 219;
const int PathFigure::IsFilledProperty = 220;
const int PathFigure::IsClosedProperty = 221;
const int NameScope::NameScopeProperty = 222;
const int MultiScaleSubImage::ZIndexProperty = 223;
const int MultiScaleSubImage::ViewportWidthProperty = 224;
const int MultiScaleSubImage::ViewportOriginProperty = 225;
const int MultiScaleSubImage::OpacityProperty = 226;
const int MultiScaleSubImage::AspectRatioProperty = 227;
const int MediaAttribute::ValueProperty = 228;
const int Matrix::OffsetYProperty = 229;
const int Matrix::OffsetXProperty = 230;
const int Matrix::M22Property = 231;
const int Matrix::M21Property = 232;
const int Matrix::M12Property = 233;
const int Matrix::M11Property = 234;
const int KeySpline::ControlPoint2Property = 235;
const int KeySpline::ControlPoint1Property = 236;
const int InputMethod::IsInputMethodEnabledProperty = 237;
const int Inline::TextDecorationsProperty = 238;
const int Inline::LanguageProperty = 239;
const int Inline::ForegroundProperty = 240;
const int Inline::FontWeightProperty = 241;
const int Inline::FontStyleProperty = 242;
const int Inline::FontStretchProperty = 243;
const int Inline::FontSourceProperty = 244;
const int Inline::FontSizeProperty = 245;
const int Inline::FontGUIDProperty = 246;
const int Inline::FontFilenameProperty = 247;
...
const int Collection::CountProperty = 270;
const int UIElement::VisibilityProperty = 271;
const int UIElement::UseLayoutRoundingProperty = 272;
const int UIElement::TriggersProperty = 273;
const int UIElement::TagProperty = 274;
const int UIElement::ResourcesProperty = 275;
const int UIElement::RenderTransformProperty = 276;
const int UIElement::RenderTransformOriginProperty = 277;
const int UIElement::OpacityProperty = 278;
const int UIElement::OpacityMaskProperty = 279;
const int UIElement::IsHitTestVisibleProperty = 280;
const int UIElement::CursorProperty = 281;
const int UIElement::ClipProperty = 282;
const int EasingFunctionBase::EasingModeProperty = 283;
const int AssemblyPart::SourceProperty = 284;
const int Application::ResourcesProperty = 285;
const int SplineColorKeyFrame::KeySplineProperty = 286;
const int EasingColorKeyFrame::EasingFunctionProperty = 287;
const int ColorAnimationUsingKeyFrames::KeyFramesProperty = 288;
const int BitmapImage::UriSourceProperty = 289;
const int BitmapImage::ProgressProperty = 290;
const int TranslateTransform::YProperty = 291;
const int TranslateTransform::XProperty = 292;
const int TransformGroup::ChildrenProperty = 293;
const int TextBox::VerticalScrollBarVisibilityProperty = 294;
const int TextBox::TextWrappingProperty = 295;
const int TextBox::TextProperty = 296;
const int TextBox::TextAlignmentProperty = 297;
const int TextBox::SelectionStartProperty = 298;
const int TextBox::SelectionLengthProperty = 299;
const int TextBox::SelectionForegroundProperty = 300;
const int TextBox::SelectionBackgroundProperty = 301;
const int TextBox::SelectedTextProperty = 302;
const int TextBox::MaxLengthProperty = 303;
const int TextBox::IsReadOnlyProperty = 304;
const int TextBox::HorizontalScrollBarVisibilityProperty = 305;
const int TextBox::FontSourceProperty = 306;
const int TextBox::AcceptsReturnProperty = 307;
const int Storyboard::TargetPropertyProperty = 308;
const int Storyboard::TargetNameProperty = 309;
const int SkewTransform::CenterYProperty = 310;
const int SkewTransform::CenterXProperty = 311;
const int SkewTransform::AngleYProperty = 312;
const int SkewTransform::AngleXProperty = 313;
const int SetterBaseCollection::IsSealedProperty = 314;
const int ScaleTransform::ScaleYProperty = 315;
const int ScaleTransform::ScaleXProperty = 316;
const int ScaleTransform::CenterYProperty = 317;
const int ScaleTransform::CenterXProperty = 318;
const int RotateTransform::CenterYProperty = 319;
const int RotateTransform::CenterXProperty = 320;
const int RotateTransform::AngleProperty = 321;
const int QuadraticBezierSegment::Point2Property = 322;
const int QuadraticBezierSegment::Point1Property = 323;
const int PolyQuadraticBezierSegment::PointsProperty = 324;
const int PolyLineSegment::PointsProperty = 325;
const int PolyBezierSegment::PointsProperty = 326;
const int PointKeyFrame::ValueProperty = 327;
const int PointKeyFrame::KeyTimeProperty = 328;
const int PointAnimation::ToProperty = 329;
const int PointAnimation::FromProperty = 330;
const int PointAnimation::EasingFunctionProperty = 331;
const int PointAnimation::ByProperty = 332;
const int PasswordBox::SelectionStartProperty = 333;
const int PasswordBox::SelectionLengthProperty = 334;
const int PasswordBox::SelectionForegroundProperty = 335;
const int PasswordBox::SelectionBackgroundProperty = 336;
const int PasswordBox::SelectedTextProperty = 337;
const int PasswordBox::PasswordProperty = 338;
const int PasswordBox::PasswordCharProperty = 339;
const int PasswordBox::MaxLengthProperty = 340;
const int PasswordBox::FontSourceProperty = 341;
const int ObjectKeyFrame::ValueProperty = 342;
const int ObjectKeyFrame::KeyTimeProperty = 343;
const int ObjectKeyFrame::ConvertedValueProperty = 344;
const int ObjectAnimationUsingKeyFrames::KeyFramesProperty = 345;
const int MatrixTransform::MatrixProperty = 346;
const int LineSegment::PointProperty = 347;
const int LayoutInformation::LayoutSlotProperty = 348;
const int LayoutInformation::LayoutClipProperty = 349;
const int LayoutInformation::LastRenderSizeProperty = 350;
const int LayoutInformation::LastMeasureProperty = 351;
const int LayoutInformation::LastArrangeProperty = 352;
const int EventTrigger::RoutedEventProperty = 353;
const int EventTrigger::ActionsProperty = 354;
const int DoubleKeyFrame::ValueProperty = 355;
const int DoubleKeyFrame::KeyTimeProperty = 356;
const int DoubleAnimation::ToProperty = 357;
const int DoubleAnimation::FromProperty = 358;
const int DoubleAnimation::EasingFunctionProperty = 359;
const int DoubleAnimation::ByProperty = 360;
const int DependencyObject::NameProperty = 361;
const int DeepZoomImageTileSource::UriSourceProperty = 362;
const int ControlTemplate::TargetTypeProperty = 363;
const int ColorKeyFrame::ValueProperty = 364;
const int ColorKeyFrame::KeyTimeProperty = 365;
const int ColorAnimation::ToProperty = 366;
const int ColorAnimation::FromProperty = 367;
const int ColorAnimation::EasingFunctionProperty = 368;
const int ColorAnimation::ByProperty = 369;
const int BitmapSource::PixelWidthProperty = 370;
const int BitmapSource::PixelHeightProperty = 371;
const int BitmapSource::PixelFormatProperty = 372;
const int BezierSegment::Point3Property = 373;
const int BezierSegment::Point2Property = 374;
const int BezierSegment::Point1Property = 375;
const int BeginStoryboard::StoryboardProperty = 376;
const int ArcSegment::SweepDirectionProperty = 377;
const int ArcSegment::SizeProperty = 378;
const int ArcSegment::RotationAngleProperty = 379;
const int ArcSegment::PointProperty = 380;
const int ArcSegment::IsLargeArcProperty = 381;
