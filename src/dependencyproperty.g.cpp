...
const int Inline::FontSourceProperty = 242;
...
const int EasingFunctionBase::EasingModeProperty = 279;
...
const int EasingColorKeyFrame::EasingFunctionProperty = 283;
const int ColorAnimationUsingKeyFrames::KeyFramesProperty = 284;
const int BitmapImage::UriSourceProperty = 285;
const int BitmapImage::ProgressProperty = 286;
const int TranslateTransform::YProperty = 287;
const int TranslateTransform::XProperty = 288;
const int TransformGroup::ChildrenProperty = 289;
const int TextBox::VerticalScrollBarVisibilityProperty = 290;
const int TextBox::TextWrappingProperty = 291;
const int TextBox::TextProperty = 292;
const int TextBox::TextAlignmentProperty = 293;
const int TextBox::SelectionStartProperty = 294;
const int TextBox::SelectionLengthProperty = 295;
const int TextBox::SelectionForegroundProperty = 296;
const int TextBox::SelectionBackgroundProperty = 297;
const int TextBox::SelectedTextProperty = 298;
const int TextBox::MaxLengthProperty = 299;
const int TextBox::IsReadOnlyProperty = 300;
const int TextBox::HorizontalScrollBarVisibilityProperty = 301;
const int TextBox::FontSourceProperty = 302;
...
const int PasswordBox::FontSourceProperty = 337;
const int ObjectKeyFrame::ValueProperty = 338;
const int ObjectKeyFrame::KeyTimeProperty = 339;
const int ObjectKeyFrame::ConvertedValueProperty = 340;
const int ObjectAnimationUsingKeyFrames::KeyFramesProperty = 341;
const int MatrixTransform::MatrixProperty = 342;
const int LineSegment::PointProperty = 343;
const int LayoutInformation::LayoutSlotProperty = 344;
const int LayoutInformation::LayoutClipProperty = 345;
const int LayoutInformation::LastRenderSizeProperty = 346;
const int LayoutInformation::LastMeasureProperty = 347;
const int LayoutInformation::LastArrangeProperty = 348;
const int EventTrigger::RoutedEventProperty = 349;
const int EventTrigger::ActionsProperty = 350;
const int DoubleKeyFrame::ValueProperty = 351;
const int DoubleKeyFrame::KeyTimeProperty = 352;
const int DoubleAnimation::ToProperty = 353;
const int DoubleAnimation::FromProperty = 354;
const int DoubleAnimation::EasingFunctionProperty = 355;
const int DoubleAnimation::ByProperty = 356;
const int DependencyObject::NameProperty = 357;
const int DeepZoomImageTileSource::UriSourceProperty = 358;
const int ControlTemplate::TargetTypeProperty = 359;
const int ColorKeyFrame::ValueProperty = 360;
const int ColorKeyFrame::KeyTimeProperty = 361;
const int ColorAnimation::ToProperty = 362;
const int ColorAnimation::FromProperty = 363;
const int ColorAnimation::EasingFunctionProperty = 364;
const int ColorAnimation::ByProperty = 365;
const int BitmapSource::PixelWidthProperty = 366;
const int BitmapSource::PixelHeightProperty = 367;
const int BitmapSource::PixelFormatProperty = 368;
const int BezierSegment::Point3Property = 369;
const int BezierSegment::Point2Property = 370;
const int BezierSegment::Point1Property = 371;
const int BeginStoryboard::StoryboardProperty = 372;
const int ArcSegment::SweepDirectionProperty = 373;
const int ArcSegment::SizeProperty = 374;
const int ArcSegment::RotationAngleProperty = 375;
const int ArcSegment::PointProperty = 376;
const int ArcSegment::IsLargeArcProperty = 377;
