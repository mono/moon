...
Type type_infos [] = {
	...
	{ Type::ARCSEGMENT, Type::PATHSEGMENT, false, "ArcSegment", "ARCSEGMENT", 0, 1, NULL, NULL, NULL }, 
	{ Type::ASSEMBLYPART, Type::DEPENDENCY_OBJECT, false, "AssemblyPart", "ASSEMBLYPART", 0, 1, NULL, NULL, NULL }, 
	{ Type::ASSEMBLYPART_COLLECTION, Type::COLLECTION, false, "AssemblyPartCollection", "ASSEMBLYPART_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	{ Type::BEGINSTORYBOARD, Type::TRIGGERACTION, false, "BeginStoryboard", "BEGINSTORYBOARD", 0, 1, NULL, NULL, "Storyboard" }, 
	{ Type::BEZIERSEGMENT, Type::PATHSEGMENT, false, "BezierSegment", "BEZIERSEGMENT", 0, 1, NULL, NULL, NULL }, 
	{ Type::BOOL, Type::INVALID, false, "bool", "BOOL", 0, 0, NULL, NULL, NULL }, 
	{ Type::BRUSH, Type::DEPENDENCY_OBJECT, false, "Brush", "BRUSH", 0, 1, NULL, NULL, NULL }, 
	{ Type::CANVAS, Type::PANEL, false, "Canvas", "CANVAS", 0, 12, NULL, NULL, NULL }, 
	...
	{ Type::COLLECTION, Type::DEPENDENCY_OBJECT, false, "Collection", "COLLECTION", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::COLORKEYFRAME_COLLECTION, Type::KEYFRAME_COLLECTION, false, "ColorKeyFrameCollection", "COLORKEYFRAME_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	{ Type::CONTROL, Type::FRAMEWORKELEMENT, false, "Control", "CONTROL", 0, 12, NULL, NULL, NULL }, 
	{ Type::DEPENDENCY_OBJECT, Type::EVENTOBJECT, false, "DependencyObject", "DEPENDENCY_OBJECT", 0, 1, NULL, NULL, NULL }, 
	{ Type::DEPLOYMENT, Type::DEPENDENCY_OBJECT, false, "Deployment", "DEPLOYMENT", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::DOUBLEKEYFRAME_COLLECTION, Type::KEYFRAME_COLLECTION, false, "DoubleKeyFrameCollection", "DOUBLEKEYFRAME_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	{ Type::DOWNLOADER, Type::DEPENDENCY_OBJECT, false, "Downloader", "DOWNLOADER", 3, 4, Downloader_Events, NULL, NULL }, 
	...
	{ Type::ELLIPSE, Type::SHAPE, false, "Ellipse", "ELLIPSE", 0, 12, NULL, NULL, NULL }, 
	...
	{ Type::EVENTTRIGGER, Type::DEPENDENCY_OBJECT, false, "EventTrigger", "EVENTTRIGGER", 0, 1, NULL, NULL, "Actions" }, 
	{ Type::FRAMEWORKELEMENT, Type::UIELEMENT, false, "FrameworkElement", "FRAMEWORKELEMENT", 0, 12, NULL, NULL, NULL }, 
	...
	{ Type::INLINES, Type::COLLECTION, false, "Inlines", "INLINES", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::KEYSPLINE, Type::DEPENDENCY_OBJECT, false, "KeySpline", "KEYSPLINE", 0, 1, NULL, NULL, NULL }, 
	{ Type::KEYTIME, Type::INVALID, false, "KeyTime", "KEYTIME", 0, 0, NULL, NULL, NULL }, 
	{ Type::LINE, Type::SHAPE, false, "Line", "LINE", 0, 12, NULL, NULL, NULL }, 
	...
	{ Type::LINEARGRADIENTBRUSH, Type::GRADIENTBRUSH, false, "LinearGradientBrush", "LINEARGRADIENTBRUSH", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::LINEBREAK, Type::INLINE, false, "LineBreak", "LINEBREAK", 0, 1, NULL, NULL, NULL }, 
	{ Type::LINEGEOMETRY, Type::GEOMETRY, false, "LineGeometry", "LINEGEOMETRY", 0, 1, NULL, (create_inst_func *) line_geometry_new, NULL }, 
	{ Type::LINESEGMENT, Type::PATHSEGMENT, false, "LineSegment", "LINESEGMENT", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::MATRIX, Type::DEPENDENCY_OBJECT, false, "Matrix", "MATRIX", 0, 1, NULL, NULL, NULL }, 
	{ Type::MATRIXTRANSFORM, Type::TRANSFORM, false, "MatrixTransform", "MATRIXTRANSFORM", 0, 1, NULL, NULL, NULL }, 
	{ Type::MEDIAATTRIBUTE, Type::DEPENDENCY_OBJECT, false, "MediaAttribute", "MEDIAATTRIBUTE", 0, 1, NULL, NULL, NULL }, 
	{ Type::MEDIAATTRIBUTE_COLLECTION, Type::COLLECTION, false, "MediaAttributeCollection", "MEDIAATTRIBUTE_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::PATH, Type::SHAPE, false, "Path", "PATH", 0, 12, NULL, NULL, NULL }, 
	...
	{ Type::PATHGEOMETRY, Type::GEOMETRY, false, "PathGeometry", "PATHGEOMETRY", 0, 1, NULL, NULL, "Figures" }, 
	...
	{ Type::POINTKEYFRAME_COLLECTION, Type::KEYFRAME_COLLECTION, false, "PointKeyFrameCollection", "POINTKEYFRAME_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	{ Type::POLYBEZIERSEGMENT, Type::PATHSEGMENT, false, "PolyBezierSegment", "POLYBEZIERSEGMENT", 0, 1, NULL, NULL, NULL }, 
	{ Type::POLYGON, Type::SHAPE, false, "Polygon", "POLYGON", 0, 12, NULL, NULL, NULL }, 
	{ Type::POLYLINE, Type::SHAPE, false, "Polyline", "POLYLINE", 0, 12, NULL, NULL, NULL }, 
	{ Type::POLYLINESEGMENT, Type::PATHSEGMENT, false, "PolyLineSegment", "POLYLINESEGMENT", 0, 1, NULL, NULL, NULL }, 
	{ Type::POLYQUADRATICBEZIERSEGMENT, Type::PATHSEGMENT, false, "PolyQuadraticBezierSegment", "POLYQUADRATICBEZIERSEGMENT", 0, 1, NULL, NULL, NULL }, 
	{ Type::QUADRATICBEZIERSEGMENT, Type::PATHSEGMENT, false, "QuadraticBezierSegment", "QUADRATICBEZIERSEGMENT", 0, 1, NULL, NULL, NULL }, 
	{ Type::RADIALGRADIENTBRUSH, Type::GRADIENTBRUSH, false, "RadialGradientBrush", "RADIALGRADIENTBRUSH", 0, 1, NULL, NULL, NULL }, 
	{ Type::RECT, Type::INVALID, false, "Rect", "RECT", 0, 0, NULL, NULL, NULL }, 
	{ Type::RECTANGLE, Type::SHAPE, false, "Rectangle", "RECTANGLE", 0, 12, NULL, NULL, NULL }, 
	...
	{ Type::RESOURCE_DICTIONARY, Type::COLLECTION, false, "ResourceDictionary", "RESOURCE_DICTIONARY", 0, 1, NULL, NULL, NULL }, 
	{ Type::ROTATETRANSFORM, Type::TRANSFORM, false, "RotateTransform", "ROTATETRANSFORM", 0, 1, NULL, NULL, NULL }, 
	{ Type::RUN, Type::INLINE, false, "Run", "RUN", 0, 1, NULL, NULL, "Text" }, 
	{ Type::SCALETRANSFORM, Type::TRANSFORM, false, "ScaleTransform", "SCALETRANSFORM", 0, 1, NULL, NULL, NULL }, 
	{ Type::SHAPE, Type::FRAMEWORKELEMENT, false, "Shape", "SHAPE", 0, 12, NULL, NULL, NULL }, 
	{ Type::SKEWTRANSFORM, Type::TRANSFORM, false, "SkewTransform", "SKEWTRANSFORM", 0, 1, NULL, NULL, NULL }, 
	{ Type::SOLIDCOLORBRUSH, Type::BRUSH, false, "SolidColorBrush", "SOLIDCOLORBRUSH", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::STORYBOARD, Type::PARALLELTIMELINE, false, "Storyboard", "STORYBOARD", 1, 2, Storyboard_Events, NULL, "Children" }, 
	...
	{ Type::STROKE_COLLECTION, Type::COLLECTION, false, "StrokeCollection", "STROKE_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::TIMELINE_COLLECTION, Type::COLLECTION, false, "TimelineCollection", "TIMELINE_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	{ Type::TIMELINEGROUP, Type::TIMELINE, false, "TimelineGroup", "TIMELINEGROUP", 0, 1, NULL, NULL, NULL }, 
	{ Type::TIMELINEMARKER, Type::DEPENDENCY_OBJECT, false, "TimelineMarker", "TIMELINEMARKER", 0, 1, NULL, NULL, NULL }, 
	{ Type::TIMELINEMARKER_COLLECTION, Type::COLLECTION, false, "TimelineMarkerCollection", "TIMELINEMARKER_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::TRANSFORM, Type::DEPENDENCY_OBJECT, false, "Transform", "TRANSFORM", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::TRANSFORMGROUP, Type::TRANSFORM, false, "TransformGroup", "TRANSFORMGROUP", 0, 1, NULL, NULL, "Children" }, 
	{ Type::TRANSLATETRANSFORM, Type::TRANSFORM, false, "TranslateTransform", "TRANSLATETRANSFORM", 0, 1, NULL, NULL, NULL }, 
	{ Type::TRIGGER_COLLECTION, Type::COLLECTION, false, "TriggerCollection", "TRIGGER_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	{ Type::TRIGGERACTION, Type::DEPENDENCY_OBJECT, false, "TriggerAction", "TRIGGERACTION", 0, 1, NULL, NULL, NULL }, 
	{ Type::TRIGGERACTION_COLLECTION, Type::COLLECTION, false, "TriggerActionCollection", "TRIGGERACTION_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	...
	{ Type::VIDEOBRUSH, Type::TILEBRUSH, false, "VideoBrush", "VIDEOBRUSH", 0, 1, NULL, NULL, NULL }, 
	{ Type::VISUAL, Type::DEPENDENCY_OBJECT, false, "Visual", "VISUAL", 0, 1, NULL, NULL, NULL }, 
	{ Type::VISUAL_COLLECTION, Type::COLLECTION, false, "VisualCollection", "VISUAL_COLLECTION", 0, 1, NULL, NULL, NULL }, 
	{ Type::VISUALBRUSH, Type::TILEBRUSH, false, "VisualBrush", "VISUALBRUSH", 0, 1, NULL, NULL, NULL }, 
