...
const int TextBox::SelectionChangedEvent = 15;
const int TextBox::TextChangedEvent = 16;
...
Type type_infos [] = {
	...
	{ Type::TEXTBOX, Type::CONTROL, false, "TextBox", "TEXTBOX", 2, 17, TextBox_Events, (create_inst_func *) text_box_new, "Text", NULL, NULL }, 
