...
Types::RegisterNativeTypes ()
{
	...
	types [(int) Type::MULTISCALESUBIMAGE_COLLECTION] = new Type (Type::MULTISCALESUBIMAGE_COLLECTION, Type::COLLECTION, false, "MultiScaleSubImageCollection", "MULTISCALESUBIMAGE_COLLECTION", 0, 1, NULL, (create_inst_func *) multi_scale_sub_image_collection_new, NULL);
