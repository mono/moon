...
const int TextBox::CursorPositionChangedEvent = 17;
const int TextBox::ModelChangedEvent = 18;
...
const char *TextBox_Events [] = { "CursorPositionChanged", "ModelChanged", "SelectionChanged", "TextChanged", NULL };
...
Types::RegisterNativeTypes ()
{
	...
	types [(int) Type::TEXTBOX] = new Type (Type::TEXTBOX, Type::CONTROL, false, "TextBox", "TEXTBOX", 4, 21, TextBox_Events, (create_inst_func *) text_box_new, NULL);
