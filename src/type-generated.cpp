...
Types::RegisterNativeTypes ()
{
	...
	types [(int) Type::ANIMATIONCLOCK] = new Type (Type::ANIMATIONCLOCK, Type::CLOCK, false, "AnimationClock", "ANIMATIONCLOCK", 0, 4, NULL, NULL, NULL);
	...
	types [(int) Type::BORDER] = new Type (Type::BORDER, Type::FRAMEWORKELEMENT, false, "Border", "BORDER", 0, 19, NULL, (create_inst_func *) border_new, "Child");
	...
	types [(int) Type::CANVAS] = new Type (Type::CANVAS, Type::PANEL, false, "Canvas", "CANVAS", 0, 19, NULL, (create_inst_func *) canvas_new, NULL);
	...
	types [(int) Type::CLOCK] = new Type (Type::CLOCK, Type::DEPENDENCY_OBJECT, false, "Clock", "CLOCK", 3, 4, Clock_Events, NULL, NULL);
	...
	types [(int) Type::CONTENTCONTROL] = new Type (Type::CONTENTCONTROL, Type::CONTROL, false, "ContentControl", "CONTENTCONTROL", 1, 21, ContentControl_Events, (create_inst_func *) content_control_new, "Content");
	types [(int) Type::CONTROL] = new Type (Type::CONTROL, Type::FRAMEWORKELEMENT, false, "Control", "CONTROL", 1, 20, Control_Events, (create_inst_func *) control_new, NULL);
	...
	types [(int) Type::DISPATCHERTIMER] = new Type (Type::DISPATCHERTIMER, Type::TIMELINE, false, "DispatcherTimer", "DISPATCHERTIMER", 1, 3, DispatcherTimer_Events, (create_inst_func *) dispatcher_timer_new, NULL);
	...
	types [(int) Type::ELLIPSE] = new Type (Type::ELLIPSE, Type::SHAPE, false, "Ellipse", "ELLIPSE", 0, 19, NULL, (create_inst_func *) ellipse_new, NULL);
	...
	types [(int) Type::FRAMEWORKELEMENT] = new Type (Type::FRAMEWORKELEMENT, Type::UIELEMENT, false, "FrameworkElement", "FRAMEWORKELEMENT", 2, 19, FrameworkElement_Events, (create_inst_func *) framework_element_new, NULL);
	...
	types [(int) Type::GLYPHS] = new Type (Type::GLYPHS, Type::FRAMEWORKELEMENT, false, "Glyphs", "GLYPHS", 0, 19, NULL, (create_inst_func *) glyphs_new, NULL);
	...
	types [(int) Type::GRID] = new Type (Type::GRID, Type::PANEL, false, "Grid", "GRID", 0, 19, NULL, (create_inst_func *) grid_new, NULL);
	...
	types [(int) Type::IMAGE] = new Type (Type::IMAGE, Type::MEDIABASE, false, "Image", "IMAGE", 1, 21, Image_Events, (create_inst_func *) image_new, NULL);
	...
	types [(int) Type::INKPRESENTER] = new Type (Type::INKPRESENTER, Type::CANVAS, false, "InkPresenter", "INKPRESENTER", 0, 19, NULL, (create_inst_func *) ink_presenter_new, NULL);
	...
	types [(int) Type::LINE] = new Type (Type::LINE, Type::SHAPE, false, "Line", "LINE", 0, 19, NULL, (create_inst_func *) line_new, NULL);
	...
	types [(int) Type::MEDIABASE] = new Type (Type::MEDIABASE, Type::FRAMEWORKELEMENT, false, "MediaBase", "MEDIABASE", 1, 20, MediaBase_Events, (create_inst_func *) media_base_new, NULL);
	...
	types [(int) Type::MEDIAELEMENT] = new Type (Type::MEDIAELEMENT, Type::FRAMEWORKELEMENT, false, "MediaElement", "MEDIAELEMENT", 7, 26, MediaElement_Events, (create_inst_func *) media_element_new, NULL);
	...
	types [(int) Type::MULTISCALEIMAGE] = new Type (Type::MULTISCALEIMAGE, Type::MEDIABASE, false, "MultiScaleImage", "MULTISCALEIMAGE", 5, 25, MultiScaleImage_Events, (create_inst_func *) multi_scale_image_new, NULL);
	...
	types [(int) Type::PANEL] = new Type (Type::PANEL, Type::FRAMEWORKELEMENT, false, "Panel", "PANEL", 0, 19, NULL, (create_inst_func *) panel_new, "Children");
	...
	types [(int) Type::PASSWORDBOX] = new Type (Type::PASSWORDBOX, Type::TEXTBOXBASE, false, "PasswordBox", "PASSWORDBOX", 1, 23, PasswordBox_Events, (create_inst_func *) password_box_new, NULL);
	types [(int) Type::PATH] = new Type (Type::PATH, Type::SHAPE, false, "Path", "PATH", 0, 19, NULL, (create_inst_func *) path_new, NULL);
	...
	types [(int) Type::POLYGON] = new Type (Type::POLYGON, Type::SHAPE, false, "Polygon", "POLYGON", 0, 19, NULL, (create_inst_func *) polygon_new, NULL);
	types [(int) Type::POLYLINE] = new Type (Type::POLYLINE, Type::SHAPE, false, "Polyline", "POLYLINE", 0, 19, NULL, (create_inst_func *) polyline_new, NULL);
	...
	types [(int) Type::POPUP] = new Type (Type::POPUP, Type::FRAMEWORKELEMENT, false, "Popup", "POPUP", 1, 20, Popup_Events, (create_inst_func *) popup_new, "Child");
	...
	types [(int) Type::RECTANGLE] = new Type (Type::RECTANGLE, Type::SHAPE, false, "Rectangle", "RECTANGLE", 0, 19, NULL, (create_inst_func *) rectangle_new, NULL);
	...
	types [(int) Type::SHAPE] = new Type (Type::SHAPE, Type::FRAMEWORKELEMENT, false, "Shape", "SHAPE", 0, 19, NULL, (create_inst_func *) shape_new, NULL);
	...
	types [(int) Type::TEXTBLOCK] = new Type (Type::TEXTBLOCK, Type::FRAMEWORKELEMENT, false, "TextBlock", "TEXTBLOCK", 0, 19, NULL, (create_inst_func *) text_block_new, "Inlines");
	types [(int) Type::TEXTBOX] = new Type (Type::TEXTBOX, Type::TEXTBOXBASE, false, "TextBox", "TEXTBOX", 2, 24, TextBox_Events, (create_inst_func *) text_box_new, NULL);
	types [(int) Type::TEXTBOXBASE] = new Type (Type::TEXTBOXBASE, Type::CONTROL, false, "TextBoxBase", "TEXTBOXBASE", 2, 22, TextBoxBase_Events, NULL, NULL);
	...
	types [(int) Type::TEXTBOXVIEW] = new Type (Type::TEXTBOXVIEW, Type::FRAMEWORKELEMENT, false, "TextBoxView", "TEXTBOXVIEW", 0, 19, NULL, (create_inst_func *) text_box_view_new, NULL);
	...
	types [(int) Type::USERCONTROL] = new Type (Type::USERCONTROL, Type::CONTROL, false, "UserControl", "USERCONTROL", 0, 20, NULL, (create_inst_func *) user_control_new, "Content");
