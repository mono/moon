...
const int ContentControl::ContentChangedEvent = 18;
const int Control::TemplateAppliedEvent = 17;
...
const int FrameworkElement::BindingValidationErrorEvent = 14;
const int FrameworkElement::LayoutUpdatedEvent = 15;
const int FrameworkElement::SizeChangedEvent = 16;
const int Image::ImageFailedEvent = 18;
...
const int MediaBase::DownloadProgressChangedEvent = 17;
const int MediaElement::BufferingProgressChangedEvent = 17;
const int MediaElement::CurrentStateChangedEvent = 18;
const int MediaElement::DownloadProgressChangedEvent = 19;
const int MediaElement::MarkerReachedEvent = 20;
const int MediaElement::MediaEndedEvent = 21;
const int MediaElement::MediaFailedEvent = 22;
const int MediaElement::MediaOpenedEvent = 23;
const int MediaPlayer::MediaEndedEvent = 1;
const int MultiScaleImage::ImageFailedEvent = 18;
const int MultiScaleImage::ImageOpenFailedEvent = 19;
const int MultiScaleImage::ImageOpenSucceededEvent = 20;
const int MultiScaleImage::MotionFinishedEvent = 21;
const int MultiScaleImage::ViewportChangedEvent = 22;
...
const int Popup::IsOpenChangedEvent = 17;
...
const int TextBox::SelectionChangedEvent = 20;
const int TextBox::TextChangedEvent = 21;
const int TextBoxBase::CursorPositionChangedEvent = 18;
const int TextBoxBase::ModelChangedEvent = 19;
...
const char *UIElement_Events [] = { "GotFocus", "Invalidated", "KeyDown", "KeyUp", "Loaded", "LostFocus", "LostMouseCapture", "MouseEnter", "MouseLeave", "MouseLeftButtonDown", "MouseLeftButtonUp", "MouseMove", "Unloaded", NULL };
...
Types::RegisterNativeTypes ()
{
	...
	types [(int) Type::CANVAS] = new Type (Type::CANVAS, Type::PANEL, false, "Canvas", "CANVAS", 0, 17, NULL, (create_inst_func *) canvas_new, NULL);
	...
	types [(int) Type::CONTENTCONTROL] = new Type (Type::CONTENTCONTROL, Type::CONTROL, false, "ContentControl", "CONTENTCONTROL", 1, 19, ContentControl_Events, (create_inst_func *) content_control_new, "Content");
	types [(int) Type::CONTROL] = new Type (Type::CONTROL, Type::FRAMEWORKELEMENT, false, "Control", "CONTROL", 1, 18, Control_Events, (create_inst_func *) control_new, NULL);
	...
	types [(int) Type::FRAMEWORKELEMENT] = new Type (Type::FRAMEWORKELEMENT, Type::UIELEMENT, false, "FrameworkElement", "FRAMEWORKELEMENT", 3, 17, FrameworkElement_Events, (create_inst_func *) framework_element_new, NULL);
	...
	types [(int) Type::GLYPHS] = new Type (Type::GLYPHS, Type::FRAMEWORKELEMENT, false, "Glyphs", "GLYPHS", 0, 17, NULL, (create_inst_func *) glyphs_new, NULL);
	...
	types [(int) Type::GRID] = new Type (Type::GRID, Type::PANEL, false, "Grid", "GRID", 0, 17, NULL, (create_inst_func *) grid_new, NULL);
	...
	types [(int) Type::INKPRESENTER] = new Type (Type::INKPRESENTER, Type::CANVAS, false, "InkPresenter", "INKPRESENTER", 0, 17, NULL, (create_inst_func *) ink_presenter_new, NULL);
	...
	types [(int) Type::LINE] = new Type (Type::LINE, Type::SHAPE, false, "Line", "LINE", 0, 17, NULL, (create_inst_func *) line_new, NULL);
	...
	types [(int) Type::MEDIABASE] = new Type (Type::MEDIABASE, Type::FRAMEWORKELEMENT, false, "MediaBase", "MEDIABASE", 1, 18, MediaBase_Events, (create_inst_func *) media_base_new, NULL);
	...
	types [(int) Type::MEDIAELEMENT] = new Type (Type::MEDIAELEMENT, Type::FRAMEWORKELEMENT, false, "MediaElement", "MEDIAELEMENT", 7, 24, MediaElement_Events, (create_inst_func *) media_element_new, NULL);
	...
	types [(int) Type::MULTISCALEIMAGE] = new Type (Type::MULTISCALEIMAGE, Type::MEDIABASE, false, "MultiScaleImage", "MULTISCALEIMAGE", 5, 23, MultiScaleImage_Events, (create_inst_func *) multi_scale_image_new, NULL);
	...
	types [(int) Type::PANEL] = new Type (Type::PANEL, Type::FRAMEWORKELEMENT, false, "Panel", "PANEL", 0, 17, NULL, (create_inst_func *) panel_new, "Children");
	...
	types [(int) Type::PASSWORDBOX] = new Type (Type::PASSWORDBOX, Type::TEXTBOXBASE, false, "PasswordBox", "PASSWORDBOX", 1, 21, PasswordBox_Events, (create_inst_func *) password_box_new, NULL);
	types [(int) Type::PATH] = new Type (Type::PATH, Type::SHAPE, false, "Path", "PATH", 0, 17, NULL, (create_inst_func *) path_new, NULL);
	...
	types [(int) Type::POLYGON] = new Type (Type::POLYGON, Type::SHAPE, false, "Polygon", "POLYGON", 0, 17, NULL, (create_inst_func *) polygon_new, NULL);
	types [(int) Type::POLYLINE] = new Type (Type::POLYLINE, Type::SHAPE, false, "Polyline", "POLYLINE", 0, 17, NULL, (create_inst_func *) polyline_new, NULL);
	...
	types [(int) Type::POPUP] = new Type (Type::POPUP, Type::FRAMEWORKELEMENT, false, "Popup", "POPUP", 1, 18, Popup_Events, (create_inst_func *) popup_new, NULL);
	...
	types [(int) Type::RECTANGLE] = new Type (Type::RECTANGLE, Type::SHAPE, false, "Rectangle", "RECTANGLE", 0, 17, NULL, (create_inst_func *) rectangle_new, NULL);
	...
	types [(int) Type::SHAPE] = new Type (Type::SHAPE, Type::FRAMEWORKELEMENT, false, "Shape", "SHAPE", 0, 17, NULL, (create_inst_func *) shape_new, NULL);
	...
	types [(int) Type::TEXTBLOCK] = new Type (Type::TEXTBLOCK, Type::FRAMEWORKELEMENT, false, "TextBlock", "TEXTBLOCK", 0, 17, NULL, (create_inst_func *) text_block_new, "Inlines");
	types [(int) Type::TEXTBOX] = new Type (Type::TEXTBOX, Type::TEXTBOXBASE, false, "TextBox", "TEXTBOX", 2, 22, TextBox_Events, (create_inst_func *) text_box_new, NULL);
	types [(int) Type::TEXTBOXBASE] = new Type (Type::TEXTBOXBASE, Type::CONTROL, false, "TextBoxBase", "TEXTBOXBASE", 2, 20, TextBoxBase_Events, NULL, NULL);
	...
	types [(int) Type::TEXTBOXVIEW] = new Type (Type::TEXTBOXVIEW, Type::FRAMEWORKELEMENT, false, "TextBoxView", "TEXTBOXVIEW", 0, 17, NULL, (create_inst_func *) text_box_view_new, NULL);
	...
	types [(int) Type::UIELEMENT] = new Type (Type::UIELEMENT, Type::DEPENDENCY_OBJECT, false, "UIElement", "UIELEMENT", 13, 14, UIElement_Events, NULL, NULL);
	...
	types [(int) Type::USERCONTROL] = new Type (Type::USERCONTROL, Type::CONTROL, false, "UserControl", "USERCONTROL", 0, 18, NULL, (create_inst_func *) user_control_new, "Content");
