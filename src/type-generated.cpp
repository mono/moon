...
const int TextBox::SelectionChangedEvent = 19;
const int TextBox::TextChangedEvent = 20;
const int TextBoxBase::CursorPositionChangedEvent = 17;
const int TextBoxBase::ModelChangedEvent = 18;
...
Types::RegisterNativeTypes ()
{
	...
	types [(int) Type::PASSWORDBOX] = new Type (Type::PASSWORDBOX, Type::TEXTBOXBASE, false, "PasswordBox", "PASSWORDBOX", 1, 20, PasswordBox_Events, (create_inst_func *) password_box_new, NULL);
	...
	types [(int) Type::TEXTBOX] = new Type (Type::TEXTBOX, Type::TEXTBOXBASE, false, "TextBox", "TEXTBOX", 2, 21, TextBox_Events, (create_inst_func *) text_box_new, NULL);
	types [(int) Type::TEXTBOXBASE] = new Type (Type::TEXTBOXBASE, Type::CONTROL, false, "TextBoxBase", "TEXTBOXBASE", 2, 19, TextBoxBase_Events, NULL, NULL);
