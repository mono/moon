...
const int Surface::AttachingEvent = 1;
const int Surface::ErrorEvent = 2;
const int Surface::FullScreenChangeEvent = 3;
...
const char *Surface_Events [] = { "Attaching", "Error", "FullScreenChange", "Resize", NULL };
...
Type type_infos [] = {
	...
	{ Type::CONTROL, Type::FRAMEWORKELEMENT, false, "Control", "CONTROL", 0, 12, NULL, (create_inst_func *) control_new, NULL }, 
