...
static struct moonlight_env_options overrides[] = {
	...
	{ "effects=yes",       RUNTIME_INIT_ENABLE_EFFECTS,        true  },
	{ "effects=no",        RUNTIME_INIT_ENABLE_EFFECTS,        false }
};
