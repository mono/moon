...
public:
	...
	enum UIElementFlags {
		...
		COMPOSITE_EFFECT = 0x10000,
		COMPOSITE_OPACITY = 0x20000,
		COMPOSITE_OPACITY_MASK = 0x40000,
		COMPOSITE_CACHE = 0x80000,
		COMPOSITE_MASK = (COMPOSITE_TRANSFORM | COMPOSITE_EFFECT | COMPOSITE_OPACITY | COMPOSITE_OPACITY_MASK | COMPOSITE_CACHE)
	};
