...
MultiScaleSubImage::MultiScaleSubImage (Uri *parent_uri, MultiScaleTileSource *tsource, int _id, int _n)
{
	...
	const char *sourceUriString = ((DeepZoomImageTileSource*)source)->GetUriSource() ? ((DeepZoomImageTileSource*)source)->GetUriSource()->originalString : "";
	const char *parentUriString = parent_uri ? parent_uri->originalString : "";
