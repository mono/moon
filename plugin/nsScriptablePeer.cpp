...
static NS_DEFINE_IID(kIScriptableIID, NS_ISCRIPTABLEMOONPLUGIN_IID);
static NS_DEFINE_IID(kIClassInfoIID, NS_ICLASSINFO_IID);
static NS_DEFINE_IID(kISupportsIID, NS_ISUPPORTS_IID);

nsScriptablePeer::nsScriptablePeer(PluginInstance* aPlugin)
{
  mPlugin = aPlugin;
  mRefCnt = 0;
printf ("@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
...
{ printf ("#######################");
  ...
  if(aIID.Equals(kIScriptableIID)) {
    *aInstancePtr = static_cast<nsIScriptableMoonPlugin*>(this); 
    AddRef();
    return NS_OK;
  }
  ...
  if(aIID.Equals(kISupportsIID)) {
    *aInstancePtr = static_cast<nsISupports*>(static_cast<nsIScriptableMoonPlugin*>(this)); 
    AddRef();
    return NS_OK;
  }
...
void nsScriptablePeer::SetInstance(PluginInstance* plugin)
{
  mPlugin = plugin;
}
