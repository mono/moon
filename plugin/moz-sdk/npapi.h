...
typedef enum {
  // CSS standard cursors
  NPCursorAlias         = 1,
  NPCursorAllScroll     = 2,
  NPCursorAuto          = 3,
  NPCursorCell          = 4,
  NPCursorContextMenu   = 5,
  NPCursorCopy          = 6,
  NPCursorCrosshair     = 7,
  NPCursorDefault       = 8,
  NPCursorHelp          = 9,
  ...
  NPCursorNoDrop        = 11,
  NPCursorNone          = 12,
  NPCursorNotAllowed    = 13,
  NPCursorPointer       = 14,
  NPCursorProgress      = 15,
  NPCursorText          = 16,
  NPCursorVerticalText  = 17,
  NPCursorWait          = 18,

  // CSS standard resize cursors
  NPCursorColResize     = 19,
  NPCursorEResize       = 20,
  NPCursorEWResize      = 21,
  NPCursorNEResize      = 22,
  NPCursorNESWResize    = 23,
  NPCursorNResize       = 24,
  NPCursorNSResize      = 25,
  NPCursorNWResize      = 26,
  NPCursorNWSEResize    = 27,
  NPCursorRowResize     = 28,
  NPCursorSEResize      = 29,
  NPCursorSResize       = 30,
  NPCursorSWResize      = 31,
  NPCursorWResize       = 32
...
#define NPVERS_HAS_WINDOWLESS_CURSORS       21
