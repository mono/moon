...
//				}
	...
	static void GenerateTypeStaticCpp (GlobalInfo all)
	{
		...
		text.AppendLine ("\ttypes [(int) Type::ENUM] = new Type (deployment, Type::ENUM, Type::OBJECT, true, true, false, \"Enum\", 0, 0, NULL, 0, NULL, false, NULL, NULL );");
		text.AppendLine ("\ttypes [(int) Type::DATETIME] = new Type (deployment, Type::DATETIME, Type::OBJECT, true, true, false, \"DateTime\", 0, 0, NULL, 0, NULL, false, NULL, NULL );");
